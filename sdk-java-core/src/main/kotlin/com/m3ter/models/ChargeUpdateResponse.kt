...
private constructor(
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [ChargeUpdateResponse].
         *
    ...
    /** A builder for [ChargeUpdateResponse]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(chargeUpdateResponse: ChargeUpdateResponse) = apply {
            id = chargeUpdateResponse.id
            accountId = chargeUpdateResponse.accountId
            accountingProductId = chargeUpdateResponse.accountingProductId
            amount = chargeUpdateResponse.amount
            billDate = chargeUpdateResponse.billDate
            billId = chargeUpdateResponse.billId
            code = chargeUpdateResponse.code
            contractId = chargeUpdateResponse.contractId
            createdBy = chargeUpdateResponse.createdBy
            currency = chargeUpdateResponse.currency
            description = chargeUpdateResponse.description
            dtCreated = chargeUpdateResponse.dtCreated
            dtLastModified = chargeUpdateResponse.dtLastModified
            entityId = chargeUpdateResponse.entityId
            entityType = chargeUpdateResponse.entityType
            lastModifiedBy = chargeUpdateResponse.lastModifiedBy
            lineItemType = chargeUpdateResponse.lineItemType
            name = chargeUpdateResponse.name
            notes = chargeUpdateResponse.notes
            scheduleId = chargeUpdateResponse.scheduleId
            servicePeriodEndDate = chargeUpdateResponse.servicePeriodEndDate
            servicePeriodStartDate = chargeUpdateResponse.servicePeriodStartDate
            unitPrice = chargeUpdateResponse.unitPrice
            units = chargeUpdateResponse.units
            version = chargeUpdateResponse.version
            additionalProperties = chargeUpdateResponse.additionalProperties.toMutableMap()
        }
        ...
        /**
         * Returns an immutable instance of [ChargeUpdateResponse].
         *
         ...
         */
        fun build(): ChargeUpdateResponse =
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is ChargeUpdateResponse &&
            id == other.id &&
