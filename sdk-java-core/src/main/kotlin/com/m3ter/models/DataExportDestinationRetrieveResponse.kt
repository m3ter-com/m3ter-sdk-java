...
@JsonDeserialize(using = DataExportDestinationRetrieveResponse.Deserializer::class)
@JsonSerialize(using = DataExportDestinationRetrieveResponse.Serializer::class)
...
private constructor(
    ...
    override fun toString(): String =
        when {
            exportDestinationS3 != null ->
                "DataExportDestinationRetrieveResponse{exportDestinationS3=$exportDestinationS3}"
            exportDestinationGoogleCloudStorage != null ->
                "DataExportDestinationRetrieveResponse{exportDestinationGoogleCloudStorage=$exportDestinationGoogleCloudStorage}"
            _json != null -> "DataExportDestinationRetrieveResponse{_unknown=$_json}"
            else -> throw IllegalStateException("Invalid DataExportDestinationRetrieveResponse")
        }
    ...
    /**
     * An interface that defines how to map each variant of [DataExportDestinationRetrieveResponse]
    ...
    interface Visitor<out T> {
        ...
        /**
         * Maps an unknown variant of [DataExportDestinationRetrieveResponse] to a value of type
         * [T].
         *
         * An instance of [DataExportDestinationRetrieveResponse] can contain an unknown variant if
        ...
        fun unknown(json: JsonValue?): T {
            throw M3terInvalidDataException("Unknown DataExportDestinationRetrieveResponse: $json")
        }
    }

    internal class Deserializer :
        BaseDeserializer<DataExportDestinationRetrieveResponse>(
            DataExportDestinationRetrieveResponse::class
        ) {
        ...
        override fun ObjectCodec.deserialize(
            ...
            return when (bestMatches.size) {
                ...
                0 -> DataExportDestinationRetrieveResponse(_json = json)
    ...
    internal class Serializer :
        BaseSerializer<DataExportDestinationRetrieveResponse>(
            DataExportDestinationRetrieveResponse::class
        ) {

        override fun serialize(
            value: DataExportDestinationRetrieveResponse,
