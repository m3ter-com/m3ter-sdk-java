 ...
 * available as a credit type for adding Credit line items to Bills. See
...
private constructor(
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [CreditReasonCreateParams].
         *
    ...
    /** A builder for [CreditReasonCreateParams]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(creditReasonCreateParams: CreditReasonCreateParams) = apply {
            orgId = creditReasonCreateParams.orgId
            body = creditReasonCreateParams.body.toBuilder()
            additionalHeaders = creditReasonCreateParams.additionalHeaders.toBuilder()
        ...
        /**
         * Returns an immutable instance of [CreditReasonCreateParams].
         *
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return /* spotless:off */ other is CreditReasonCreateParams && orgId == other.orgId && body == other.body && additionalHeaders == other.additionalHeaders && additionalQueryParams == other.additionalQueryParams /* spotless:on */
    }

    override fun hashCode(): Int = /* spotless:off */ Objects.hash(orgId, body, additionalHeaders, additionalQueryParams) /* spotless:on */

    override fun toString() =
        "CreditReasonCreateParams{orgId=$orgId, body=$body, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
