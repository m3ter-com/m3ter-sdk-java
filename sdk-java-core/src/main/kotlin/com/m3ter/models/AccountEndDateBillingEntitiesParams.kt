...
private constructor(
    ...
    /** A builder for [AccountEndDateBillingEntitiesParams]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(
            accountEndDateBillingEntitiesParams: AccountEndDateBillingEntitiesParams
        ) = apply {
            orgId = accountEndDateBillingEntitiesParams.orgId
            id = accountEndDateBillingEntitiesParams.id
            body = accountEndDateBillingEntitiesParams.body.toBuilder()
            additionalHeaders = accountEndDateBillingEntitiesParams.additionalHeaders.toBuilder()
        ...
        /**
         * Returns an immutable instance of [AccountEndDateBillingEntitiesParams].
         *
