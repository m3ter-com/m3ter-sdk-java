 ...
 *
 * Update the details of a specific StatementDefinition for the specified Organization, using its
 * unique identifier (UUID). The updated details for the StatementDefinition should be sent in the
 * request body.
 */
class StatementStatementDefinitionUpdateParams
private constructor(
    ...
    companion object {
         ...
         * [StatementStatementDefinitionUpdateParams].
         *
    ...
    /** A builder for [StatementStatementDefinitionUpdateParams]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(
            statementStatementDefinitionUpdateParams: StatementStatementDefinitionUpdateParams
        ) = apply {
            orgId = statementStatementDefinitionUpdateParams.orgId
            id = statementStatementDefinitionUpdateParams.id
            body = statementStatementDefinitionUpdateParams.body.toBuilder()
            additionalHeaders =
                statementStatementDefinitionUpdateParams.additionalHeaders.toBuilder()
            additionalQueryParams =
                statementStatementDefinitionUpdateParams.additionalQueryParams.toBuilder()
        }
        ...
        /**
         * Returns an immutable instance of [StatementStatementDefinitionUpdateParams].
         *
         ...
         */
        fun build(): StatementStatementDefinitionUpdateParams =
            StatementStatementDefinitionUpdateParams(
                orgId,
                id,
                body.build(),
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return /* spotless:off */ other is StatementStatementDefinitionUpdateParams && orgId == other.orgId && id == other.id && body == other.body && additionalHeaders == other.additionalHeaders && additionalQueryParams == other.additionalQueryParams /* spotless:on */
    }

    override fun hashCode(): Int = /* spotless:off */ Objects.hash(orgId, id, body, additionalHeaders, additionalQueryParams) /* spotless:on */

    override fun toString() =
        "StatementStatementDefinitionUpdateParams{orgId=$orgId, id=$id, body=$body, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
