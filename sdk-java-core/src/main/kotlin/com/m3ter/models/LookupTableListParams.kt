...
private constructor(
     ...
     * example,if you want to include the active Revision for each of the Lookup Tables returned,
     * set `additional=activeRevision` in the query.
     */
    ...
    companion object {
        ...
        @JvmStatic fun none(): LookupTableListParams = builder().build()

        /** Returns a mutable builder for constructing an instance of [LookupTableListParams]. */
        @JvmStatic fun builder() = Builder()
    }

    /** A builder for [LookupTableListParams]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(lookupTableListParams: LookupTableListParams) = apply {
            orgId = lookupTableListParams.orgId
            additional = lookupTableListParams.additional?.toMutableList()
            codes = lookupTableListParams.codes?.toMutableList()
            nextToken = lookupTableListParams.nextToken
            pageSize = lookupTableListParams.pageSize
            additionalHeaders = lookupTableListParams.additionalHeaders.toBuilder()
            additionalQueryParams = lookupTableListParams.additionalQueryParams.toBuilder()
        }
        ...
        /**
         * Comma separated list of additional non-default fields to be included in the response. For
         * example,if you want to include the active Revision for each of the Lookup Tables
         * returned, set `additional=activeRevision` in the query.
         */
        ...
        /**
         * Returns an immutable instance of [LookupTableListParams].
         *
         * Further updates to this [Builder] will not mutate the returned instance.
         */
        fun build(): LookupTableListParams =
            LookupTableListParams(
                orgId,
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is LookupTableListParams &&
            orgId == other.orgId &&
    ...
    override fun toString() =
        "LookupTableListParams{orgId=$orgId, additional=$additional, codes=$codes, nextToken=$nextToken, pageSize=$pageSize, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
