...
private constructor(
    ...
    companion object {
        ...
        @JvmStatic fun none(): PermissionPolicyAddToSupportUserParams = builder().build()
    ...
    /** A builder for [PermissionPolicyAddToSupportUserParams]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(
            permissionPolicyAddToSupportUserParams: PermissionPolicyAddToSupportUserParams
        ) = apply {
            orgId = permissionPolicyAddToSupportUserParams.orgId
            permissionPolicyId = permissionPolicyAddToSupportUserParams.permissionPolicyId
            body = permissionPolicyAddToSupportUserParams.body.toBuilder()
            additionalHeaders = permissionPolicyAddToSupportUserParams.additionalHeaders.toBuilder()
        ...
        /**
         * Returns an immutable instance of [PermissionPolicyAddToSupportUserParams].
         *
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return /* spotless:off */ other is PermissionPolicyAddToSupportUserParams && orgId == other.orgId && permissionPolicyId == other.permissionPolicyId && body == other.body && additionalHeaders == other.additionalHeaders && additionalQueryParams == other.additionalQueryParams /* spotless:on */
    }
    ...
    override fun toString() =
        "PermissionPolicyAddToSupportUserParams{orgId=$orgId, permissionPolicyId=$permissionPolicyId, body=$body, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
