...
private constructor(
    ...
    /** A builder for [PermissionPolicyRemoveFromUserParams]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(
            permissionPolicyRemoveFromUserParams: PermissionPolicyRemoveFromUserParams
        ) = apply {
        ...
        /**
         * Returns an immutable instance of [PermissionPolicyRemoveFromUserParams].
         *
         ...
         */
        fun build(): PermissionPolicyRemoveFromUserParams =
            PermissionPolicyRemoveFromUserParams(
                orgId,
                permissionPolicyId,
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is PermissionPolicyRemoveFromUserParams &&
            orgId == other.orgId &&
