...
private constructor(
    ...
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(
            permissionPolicyAddToSupportUserResponse: PermissionPolicyAddToSupportUserResponse
        ) = apply {
            id = permissionPolicyAddToSupportUserResponse.id
            createdBy = permissionPolicyAddToSupportUserResponse.createdBy
            dtCreated = permissionPolicyAddToSupportUserResponse.dtCreated
            dtLastModified = permissionPolicyAddToSupportUserResponse.dtLastModified
            lastModifiedBy = permissionPolicyAddToSupportUserResponse.lastModifiedBy
            permissionPolicyId = permissionPolicyAddToSupportUserResponse.permissionPolicyId
            principalId = permissionPolicyAddToSupportUserResponse.principalId
            principalType = permissionPolicyAddToSupportUserResponse.principalType
            version = permissionPolicyAddToSupportUserResponse.version
    ...
    override fun toString() =
        "PermissionPolicyAddToSupportUserResponse{id=$id, createdBy=$createdBy, dtCreated=$dtCreated, dtLastModified=$dtLastModified, lastModifiedBy=$lastModifiedBy, permissionPolicyId=$permissionPolicyId, principalId=$principalId, principalType=$principalType, version=$version, additionalProperties=$additionalProperties}"
}
