 ...
 * Create a new Meter.
 *
 * When you create a Meter, you can define two types of field for usage data collection and ingest
 * into the platform:
 * - `dataFields` to collect raw usage data measures - numeric quantitative data values or
 *   non-numeric point data values.
 * - `derivedFields` to derive usage data measures that are the result of applying a calculation to
 *   `dataFields`, `customFields`, or system `Timestamp` fields.
 *
 * You can also:
 * - Create `customFields` for a Meter, which allows you to attach custom data to the Meter as
 *   name/value pairs.
 * - Create Global Meters, which are not tied to a specific Product and allow you collect to usage
 *   data that will form the basis of usage-based pricing across more than one of your Products.
 *
 ...
 * that any fields you configure for Meters, such as Data Fields or Derived Fields, do not contain
 * any end-customer PII data. See the
...
private constructor(
    ...
    private constructor(
        ...
        class Builder internal constructor() {
             ...
             * Sets [Builder.dataFields] to an arbitrary JSON value.
             *
             * You should usually call [Builder.dataFields] with a well-typed `List<DataField>`
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return /* spotless:off */ other is MeterCreateParams && orgId == other.orgId && body == other.body && additionalHeaders == other.additionalHeaders && additionalQueryParams == other.additionalQueryParams /* spotless:on */
    }

    override fun hashCode(): Int = /* spotless:off */ Objects.hash(orgId, body, additionalHeaders, additionalQueryParams) /* spotless:on */

    override fun toString() =
        "MeterCreateParams{orgId=$orgId, body=$body, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
