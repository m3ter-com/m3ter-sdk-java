...
private constructor(
    ...
    private val statementId: JsonField<String>,
    ...
    private constructor(
        ...
        @ExcludeMissing
        statementId: JsonField<String> = JsonMissing.of(),
     ...
     *   server responded with an unexpected value).
     */
    fun statementId(): Optional<String> = statementId.getOptional("statementId")
    ...
    /**
     * Returns the raw JSON value of [statementId].
     *
     * Unlike [statementId], this method doesn't throw if the JSON field has an unexpected type.
     */
    @JsonProperty("statementId") @ExcludeMissing fun _statementId(): JsonField<String> = statementId
    ...
    class Builder internal constructor() {
        ...
        private var statementId: JsonField<String> = JsonMissing.of()
        ...
        internal fun from(statementJobResponse: StatementJobResponse) = apply {
            ...
            statementId = statementJobResponse.statementId
        ...
        /** The unique identifier (UUID) of the statement generated by the StatementJob. */
        fun statementId(statementId: String) = statementId(JsonField.of(statementId))

        /**
         * Sets [Builder.statementId] to an arbitrary JSON value.
         *
         * You should usually call [Builder.statementId] with a well-typed [String] value instead.
         * This method is primarily for setting the field to an undocumented or not yet supported
         * value.
         */
        fun statementId(statementId: JsonField<String>) = apply { this.statementId = statementId }
    ...
    internal fun validity(): Int =
        (if (id.asKnown().isPresent) 1 else 0) +
            ...
            (if (statementId.asKnown().isPresent) 1 else 0) +
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return /* spotless:off */ other is StatementJobResponse && id == other.id && version == other.version && billId == other.billId && createdBy == other.createdBy && dtCreated == other.dtCreated && dtLastModified == other.dtLastModified && includeCsvFormat == other.includeCsvFormat && lastModifiedBy == other.lastModifiedBy && orgId == other.orgId && presignedJsonStatementUrl == other.presignedJsonStatementUrl && statementId == other.statementId && statementJobStatus == other.statementJobStatus && additionalProperties == other.additionalProperties /* spotless:on */
    }

    /* spotless:off */
    private val hashCode: Int by lazy { Objects.hash(id, version, billId, createdBy, dtCreated, dtLastModified, includeCsvFormat, lastModifiedBy, orgId, presignedJsonStatementUrl, statementId, statementJobStatus, additionalProperties) }
    /* spotless:on */

    override fun hashCode(): Int = hashCode

    override fun toString() =
        "StatementJobResponse{id=$id, version=$version, billId=$billId, createdBy=$createdBy, dtCreated=$dtCreated, dtLastModified=$dtLastModified, includeCsvFormat=$includeCsvFormat, lastModifiedBy=$lastModifiedBy, orgId=$orgId, presignedJsonStatementUrl=$presignedJsonStatementUrl, statementId=$statementId, statementJobStatus=$statementJobStatus, additionalProperties=$additionalProperties}"
}
