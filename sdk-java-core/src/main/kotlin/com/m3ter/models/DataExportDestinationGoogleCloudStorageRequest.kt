...
private constructor(
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return /* spotless:off */ other is DataExportDestinationGoogleCloudStorageRequest && bucketName == other.bucketName && poolId == other.poolId && projectNumber == other.projectNumber && providerId == other.providerId && partitionOrder == other.partitionOrder && prefix == other.prefix && serviceAccountEmail == other.serviceAccountEmail && version == other.version && additionalProperties == other.additionalProperties /* spotless:on */
    }

    /* spotless:off */
    private val hashCode: Int by lazy { Objects.hash(bucketName, poolId, projectNumber, providerId, partitionOrder, prefix, serviceAccountEmail, version, additionalProperties) }
    /* spotless:on */

    override fun hashCode(): Int = hashCode

    override fun toString() =
        "DataExportDestinationGoogleCloudStorageRequest{bucketName=$bucketName, poolId=$poolId, projectNumber=$projectNumber, providerId=$providerId, partitionOrder=$partitionOrder, prefix=$prefix, serviceAccountEmail=$serviceAccountEmail, version=$version, additionalProperties=$additionalProperties}"
}
