...
class CommitmentListPageResponse
private constructor(
    private val data: JsonField<List<CommitmentResponse>>,
    ...
    private constructor(
        @JsonProperty("data")
        @ExcludeMissing
        data: JsonField<List<CommitmentResponse>> = JsonMissing.of(),
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [CommitmentListPageResponse].
         */
        @JvmStatic fun builder() = Builder()
    }

    /** A builder for [CommitmentListPageResponse]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(commitmentListPageResponse: CommitmentListPageResponse) = apply {
            data = commitmentListPageResponse.data.map { it.toMutableList() }
            nextToken = commitmentListPageResponse.nextToken
            additionalProperties = commitmentListPageResponse.additionalProperties.toMutableMap()
        }
         ...
         *
         * You should usually call [Builder.data] with a well-typed `List<CommitmentResponse>` value
        ...
        /**
         * Adds a single [CommitmentResponse] to [Builder.data].
         *
        ...
        /**
         * Returns an immutable instance of [CommitmentListPageResponse].
         *
         * Further updates to this [Builder] will not mutate the returned instance.
         */
        fun build(): CommitmentListPageResponse =
            CommitmentListPageResponse(
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return /* spotless:off */ other is CommitmentListPageResponse && data == other.data && nextToken == other.nextToken && additionalProperties == other.additionalProperties /* spotless:on */
    }
    ...
    override fun toString() =
        "CommitmentListPageResponse{data=$data, nextToken=$nextToken, additionalProperties=$additionalProperties}"
}
