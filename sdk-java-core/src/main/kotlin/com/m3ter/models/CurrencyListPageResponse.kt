...
private constructor(
    ...
    private constructor(
        @JsonProperty("data")
        @ExcludeMissing
        data: JsonField<List<CurrencyResponse>> = JsonMissing.of(),
        @JsonProperty("nextToken") @ExcludeMissing nextToken: JsonField<String> = JsonMissing.of(),
    ) : this(data, nextToken, mutableMapOf())

    /**
     * The list of Currency information.
     *
     * @throws M3terInvalidDataException if the JSON field has an unexpected type (e.g. if the
     *   server responded with an unexpected value).
     */
    fun data(): Optional<List<CurrencyResponse>> = data.getOptional("data")
     ...
     */
    @JsonProperty("data") @ExcludeMissing fun _data(): JsonField<List<CurrencyResponse>> = data
    ...
    companion object {
        ...
        /** Returns a mutable builder for constructing an instance of [CurrencyListPageResponse]. */
        @JvmStatic fun builder() = Builder()
    }

    /** A builder for [CurrencyListPageResponse]. */
    class Builder internal constructor() {

        private var data: JsonField<MutableList<CurrencyResponse>>? = null
        private var nextToken: JsonField<String> = JsonMissing.of()
        private var additionalProperties: MutableMap<String, JsonValue> = mutableMapOf()

        @JvmSynthetic
        internal fun from(currencyListPageResponse: CurrencyListPageResponse) = apply {
            data = currencyListPageResponse.data.map { it.toMutableList() }
            nextToken = currencyListPageResponse.nextToken
            additionalProperties = currencyListPageResponse.additionalProperties.toMutableMap()
        }
         ...
         *
         * You should usually call [Builder.data] with a well-typed `List<CurrencyResponse>` value
         * instead. This method is primarily for setting the field to an undocumented or not yet
         * supported value.
         */
        fun data(data: JsonField<List<CurrencyResponse>>) = apply {
            this.data = data.map { it.toMutableList() }
        }

        /**
         * Adds a single [CurrencyResponse] to [Builder.data].
         *
         * @throws IllegalStateException if the field was previously set to a non-list.
         */
        fun addData(data: CurrencyResponse) = apply {
            this.data =
        ...
        /**
         * Returns an immutable instance of [CurrencyListPageResponse].
         *
         * Further updates to this [Builder] will not mutate the returned instance.
         */
        fun build(): CurrencyListPageResponse =
            CurrencyListPageResponse(
    ...
    override fun toString() =
        "CurrencyListPageResponse{data=$data, nextToken=$nextToken, additionalProperties=$additionalProperties}"
}
