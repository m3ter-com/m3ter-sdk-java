...
private constructor(
    ...
    companion object {
        ...
        /** Returns a mutable builder for constructing an instance of [BillListPageResponse]. */
        @JvmStatic fun builder() = Builder()
    }

    /** A builder for [BillListPageResponse]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(billListPageResponse: BillListPageResponse) = apply {
            data = billListPageResponse.data.map { it.toMutableList() }
            nextToken = billListPageResponse.nextToken
            additionalProperties = billListPageResponse.additionalProperties.toMutableMap()
        }
        ...
        /**
         * Returns an immutable instance of [BillListPageResponse].
         *
         * Further updates to this [Builder] will not mutate the returned instance.
         */
        fun build(): BillListPageResponse =
            BillListPageResponse(
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return /* spotless:off */ other is BillListPageResponse && data == other.data && nextToken == other.nextToken && additionalProperties == other.additionalProperties /* spotless:on */
    }
    ...
    override fun toString() =
        "BillListPageResponse{data=$data, nextToken=$nextToken, additionalProperties=$additionalProperties}"
}
