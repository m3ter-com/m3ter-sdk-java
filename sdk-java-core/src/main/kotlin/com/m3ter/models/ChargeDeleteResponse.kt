...
private constructor(
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [ChargeDeleteResponse].
         *
    ...
    /** A builder for [ChargeDeleteResponse]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(chargeDeleteResponse: ChargeDeleteResponse) = apply {
            id = chargeDeleteResponse.id
            accountId = chargeDeleteResponse.accountId
            accountingProductId = chargeDeleteResponse.accountingProductId
            amount = chargeDeleteResponse.amount
            billDate = chargeDeleteResponse.billDate
            billId = chargeDeleteResponse.billId
            code = chargeDeleteResponse.code
            contractId = chargeDeleteResponse.contractId
            createdBy = chargeDeleteResponse.createdBy
            currency = chargeDeleteResponse.currency
            description = chargeDeleteResponse.description
            dtCreated = chargeDeleteResponse.dtCreated
            dtLastModified = chargeDeleteResponse.dtLastModified
            entityId = chargeDeleteResponse.entityId
            entityType = chargeDeleteResponse.entityType
            lastModifiedBy = chargeDeleteResponse.lastModifiedBy
            lineItemType = chargeDeleteResponse.lineItemType
            name = chargeDeleteResponse.name
            notes = chargeDeleteResponse.notes
            scheduleId = chargeDeleteResponse.scheduleId
            servicePeriodEndDate = chargeDeleteResponse.servicePeriodEndDate
            servicePeriodStartDate = chargeDeleteResponse.servicePeriodStartDate
            unitPrice = chargeDeleteResponse.unitPrice
            units = chargeDeleteResponse.units
            version = chargeDeleteResponse.version
            additionalProperties = chargeDeleteResponse.additionalProperties.toMutableMap()
        }
        ...
        /**
         * Returns an immutable instance of [ChargeDeleteResponse].
         *
         ...
         */
        fun build(): ChargeDeleteResponse =
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is ChargeDeleteResponse &&
            id == other.id &&
