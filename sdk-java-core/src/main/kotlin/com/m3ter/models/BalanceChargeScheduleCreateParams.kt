...
class BalanceChargeScheduleCreateParams
private constructor(
    ...
    companion object {
         ...
         * [BalanceChargeScheduleCreateParams].
         *
    ...
    /** A builder for [BalanceChargeScheduleCreateParams]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(balanceChargeScheduleCreateParams: BalanceChargeScheduleCreateParams) =
            apply {
                orgId = balanceChargeScheduleCreateParams.orgId
                balanceId = balanceChargeScheduleCreateParams.balanceId
                body = balanceChargeScheduleCreateParams.body.toBuilder()
                additionalHeaders = balanceChargeScheduleCreateParams.additionalHeaders.toBuilder()
                additionalQueryParams =
                    balanceChargeScheduleCreateParams.additionalQueryParams.toBuilder()
            }
        ...
        /**
         * Returns an immutable instance of [BalanceChargeScheduleCreateParams].
         *
         ...
         */
        fun build(): BalanceChargeScheduleCreateParams =
            BalanceChargeScheduleCreateParams(
                orgId,
                balanceId,
                body.build(),
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is BalanceChargeScheduleCreateParams &&
            orgId == other.orgId &&
    ...
    override fun toString() =
        "BalanceChargeScheduleCreateParams{orgId=$orgId, balanceId=$balanceId, body=$body, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
