...
private constructor(
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is IntegrationConfigurationDeleteResponse &&
            id == other.id &&
