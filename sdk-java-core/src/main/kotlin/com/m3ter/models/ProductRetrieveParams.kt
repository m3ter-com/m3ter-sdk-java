 ...
 *
 * This endpoint retrieves the details of a specific Product within a specified Organization, using
 * the Product UUID.
 */
...
private constructor(
    ...
    class Builder internal constructor() {
        ...
        internal fun from(productRetrieveParams: ProductRetrieveParams) = apply {
            orgId = productRetrieveParams.orgId
            id = productRetrieveParams.id
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return /* spotless:off */ other is ProductRetrieveParams && orgId == other.orgId && id == other.id && additionalHeaders == other.additionalHeaders && additionalQueryParams == other.additionalQueryParams /* spotless:on */
    }

    override fun hashCode(): Int = /* spotless:off */ Objects.hash(orgId, id, additionalHeaders, additionalQueryParams) /* spotless:on */

    override fun toString() =
        "ProductRetrieveParams{orgId=$orgId, id=$id, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
