...
@JsonDeserialize(using = DataExportDestinationUpdateResponse.Deserializer::class)
@JsonSerialize(using = DataExportDestinationUpdateResponse.Serializer::class)
class DataExportDestinationUpdateResponse
private constructor(
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return /* spotless:off */ other is DataExportDestinationUpdateResponse && exportDestinationS3 == other.exportDestinationS3 && exportDestinationGoogleCloudStorage == other.exportDestinationGoogleCloudStorage /* spotless:on */
    }
    ...
    override fun toString(): String =
        when {
            exportDestinationS3 != null ->
                "DataExportDestinationUpdateResponse{exportDestinationS3=$exportDestinationS3}"
            exportDestinationGoogleCloudStorage != null ->
                "DataExportDestinationUpdateResponse{exportDestinationGoogleCloudStorage=$exportDestinationGoogleCloudStorage}"
            _json != null -> "DataExportDestinationUpdateResponse{_unknown=$_json}"
            else -> throw IllegalStateException("Invalid DataExportDestinationUpdateResponse")
        }
    ...
    /**
     * An interface that defines how to map each variant of [DataExportDestinationUpdateResponse] to
     * a value of type [T].
     */
    interface Visitor<out T> {
        ...
        /**
         * Maps an unknown variant of [DataExportDestinationUpdateResponse] to a value of type [T].
         *
         * An instance of [DataExportDestinationUpdateResponse] can contain an unknown variant if it
        ...
        fun unknown(json: JsonValue?): T {
            throw M3terInvalidDataException("Unknown DataExportDestinationUpdateResponse: $json")
        }
    }

    internal class Deserializer :
        BaseDeserializer<DataExportDestinationUpdateResponse>(
            DataExportDestinationUpdateResponse::class
        ) {
        ...
        override fun ObjectCodec.deserialize(node: JsonNode): DataExportDestinationUpdateResponse {
            ...
            return when (bestMatches.size) {
                ...
                0 -> DataExportDestinationUpdateResponse(_json = json)
    ...
    internal class Serializer :
        BaseSerializer<DataExportDestinationUpdateResponse>(
            DataExportDestinationUpdateResponse::class
        ) {

        override fun serialize(
            value: DataExportDestinationUpdateResponse,
