...
private constructor(
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [ChargeRetrieveResponse].
         *
    ...
    /** A builder for [ChargeRetrieveResponse]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(chargeRetrieveResponse: ChargeRetrieveResponse) = apply {
            id = chargeRetrieveResponse.id
            accountId = chargeRetrieveResponse.accountId
            accountingProductId = chargeRetrieveResponse.accountingProductId
            amount = chargeRetrieveResponse.amount
            billDate = chargeRetrieveResponse.billDate
            billId = chargeRetrieveResponse.billId
            code = chargeRetrieveResponse.code
            contractId = chargeRetrieveResponse.contractId
            createdBy = chargeRetrieveResponse.createdBy
            currency = chargeRetrieveResponse.currency
            description = chargeRetrieveResponse.description
            dtCreated = chargeRetrieveResponse.dtCreated
            dtLastModified = chargeRetrieveResponse.dtLastModified
            entityId = chargeRetrieveResponse.entityId
            entityType = chargeRetrieveResponse.entityType
            lastModifiedBy = chargeRetrieveResponse.lastModifiedBy
            lineItemType = chargeRetrieveResponse.lineItemType
            name = chargeRetrieveResponse.name
            notes = chargeRetrieveResponse.notes
            scheduleId = chargeRetrieveResponse.scheduleId
            servicePeriodEndDate = chargeRetrieveResponse.servicePeriodEndDate
            servicePeriodStartDate = chargeRetrieveResponse.servicePeriodStartDate
            unitPrice = chargeRetrieveResponse.unitPrice
            units = chargeRetrieveResponse.units
            version = chargeRetrieveResponse.version
            additionalProperties = chargeRetrieveResponse.additionalProperties.toMutableMap()
        }
        ...
        /**
         * Returns an immutable instance of [ChargeRetrieveResponse].
         *
         ...
         */
        fun build(): ChargeRetrieveResponse =
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is ChargeRetrieveResponse &&
            id == other.id &&
