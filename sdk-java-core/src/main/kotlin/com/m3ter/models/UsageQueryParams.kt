...
private constructor(
     ...
     *   server responded with an unexpected value).
     */
    fun groups(): Optional<List<DataExplorerGroup>> = body.groups()
     ...
     */
    fun _groups(): JsonField<List<DataExplorerGroup>> = body._groups()
    ...
    class Builder internal constructor() {
         ...
         * you'll receive an error.
         */
        fun groups(groups: List<DataExplorerGroup>) = apply { body.groups(groups) }
         ...
         * yet supported value.
         */
        fun groups(groups: JsonField<List<DataExplorerGroup>>) = apply { body.groups(groups) }
         ...
         * @throws IllegalStateException if the field was previously set to a non-list.
         */
        fun addGroup(group: DataExplorerGroup) = apply { body.addGroup(group) }
