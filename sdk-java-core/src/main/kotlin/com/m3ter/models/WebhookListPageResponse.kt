...
private constructor(
    private val data: JsonField<List<Webhook>>,
    ...
    @JsonCreator
    private constructor(
        @JsonProperty("data") @ExcludeMissing data: JsonField<List<Webhook>> = JsonMissing.of(),
     ...
     */
    fun data(): Optional<List<Webhook>> = data.getOptional("data")
     ...
     */
    @JsonProperty("data") @ExcludeMissing fun _data(): JsonField<List<Webhook>> = data
    ...
    class Builder internal constructor() {
        ...
        private var data: JsonField<MutableList<Webhook>>? = null
        ...
        internal fun from(webhookListPageResponse: WebhookListPageResponse) = apply {
            ...
            nextToken = webhookListPageResponse.nextToken
         ...
         *
         * You should usually call [Builder.data] with a well-typed `List<Webhook>` value instead.
         * This method is primarily for setting the field to an undocumented or not yet supported
         * value.
         */
        fun data(data: JsonField<List<Webhook>>) = apply {
            this.data = data.map { it.toMutableList() }
        }

        /**
         * Adds a single [Webhook] to [Builder.data].
         *
         * @throws IllegalStateException if the field was previously set to a non-list.
         */
        fun addData(data: Webhook) = apply {
            this.data =
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return /* spotless:off */ other is WebhookListPageResponse && data == other.data && nextToken == other.nextToken && additionalProperties == other.additionalProperties /* spotless:on */
    }
    ...
    override fun toString() =
        "WebhookListPageResponse{data=$data, nextToken=$nextToken, additionalProperties=$additionalProperties}"
}
