...
private constructor(
    ...
    companion object {
        ...
        @JvmStatic fun none(): ContractRetrieveParams = builder().build()
    ...
    class Builder internal constructor() {
        ...
        internal fun from(contractRetrieveParams: ContractRetrieveParams) = apply {
            orgId = contractRetrieveParams.orgId
            id = contractRetrieveParams.id
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return /* spotless:off */ other is ContractRetrieveParams && orgId == other.orgId && id == other.id && additionalHeaders == other.additionalHeaders && additionalQueryParams == other.additionalQueryParams /* spotless:on */
    }

    override fun hashCode(): Int = /* spotless:off */ Objects.hash(orgId, id, additionalHeaders, additionalQueryParams) /* spotless:on */

    override fun toString() =
        "ContractRetrieveParams{orgId=$orgId, id=$id, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
