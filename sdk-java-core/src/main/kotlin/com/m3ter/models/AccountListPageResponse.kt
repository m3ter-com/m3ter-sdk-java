...
private constructor(
    ...
    class Builder internal constructor() {
        ...
        internal fun from(accountListPageResponse: AccountListPageResponse) = apply {
            ...
            nextToken = accountListPageResponse.nextToken
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return /* spotless:off */ other is AccountListPageResponse && data == other.data && nextToken == other.nextToken && additionalProperties == other.additionalProperties /* spotless:on */
    }
    ...
    override fun toString() =
        "AccountListPageResponse{data=$data, nextToken=$nextToken, additionalProperties=$additionalProperties}"
}
