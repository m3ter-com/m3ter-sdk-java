 ...
 * * The returned URL is presigned - you can copy it into a browser and the data file is downloaded
 *   locally.
 * * The upload URL is time limited - the `expiry` time is given in the response and the URL is
 *   valid for ***one hour***.
 */
class LookupTableLookupTableRevisionDataArchieveParams
private constructor(
    ...
    companion object {
         ...
         * [LookupTableLookupTableRevisionDataArchieveParams].
         *
    ...
    /** A builder for [LookupTableLookupTableRevisionDataArchieveParams]. */
    class Builder internal constructor() {
        ...
        internal fun from(
            ...
            orgId = lookupTableLookupTableRevisionDataArchieveParams.orgId
            lookupTableId = lookupTableLookupTableRevisionDataArchieveParams.lookupTableId
            lookupTableRevisionId =
                lookupTableLookupTableRevisionDataArchieveParams.lookupTableRevisionId
            body = lookupTableLookupTableRevisionDataArchieveParams.body.toBuilder()
            additionalHeaders =
                lookupTableLookupTableRevisionDataArchieveParams.additionalHeaders.toBuilder()
            additionalQueryParams =
                lookupTableLookupTableRevisionDataArchieveParams.additionalQueryParams.toBuilder()
        }
        ...
        /**
         * Returns an immutable instance of [LookupTableLookupTableRevisionDataArchieveParams].
         *
         ...
         */
        fun build(): LookupTableLookupTableRevisionDataArchieveParams =
            LookupTableLookupTableRevisionDataArchieveParams(
                orgId,
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is LookupTableLookupTableRevisionDataArchieveParams &&
            orgId == other.orgId &&
    ...
    override fun toString() =
        "LookupTableLookupTableRevisionDataArchieveParams{orgId=$orgId, lookupTableId=$lookupTableId, lookupTableRevisionId=$lookupTableRevisionId, body=$body, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
