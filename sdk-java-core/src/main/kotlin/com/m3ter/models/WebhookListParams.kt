...
private constructor(
    ...
    class Builder internal constructor() {
        ...
        internal fun from(webhookListParams: WebhookListParams) = apply {
            orgId = webhookListParams.orgId
            ids = webhookListParams.ids?.toMutableList()
            nextToken = webhookListParams.nextToken
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return /* spotless:off */ other is WebhookListParams && orgId == other.orgId && ids == other.ids && nextToken == other.nextToken && pageSize == other.pageSize && additionalHeaders == other.additionalHeaders && additionalQueryParams == other.additionalQueryParams /* spotless:on */
    }
    ...
    override fun toString() =
        "WebhookListParams{orgId=$orgId, ids=$ids, nextToken=$nextToken, pageSize=$pageSize, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
