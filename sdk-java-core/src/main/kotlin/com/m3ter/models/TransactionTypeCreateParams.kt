...
/**
 * Create a new TransactionType for the specified Organization. Details of the new TransactionType
...
private constructor(
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [TransactionTypeCreateParams].
         *
    ...
    /** A builder for [TransactionTypeCreateParams]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(transactionTypeCreateParams: TransactionTypeCreateParams) = apply {
            orgId = transactionTypeCreateParams.orgId
            body = transactionTypeCreateParams.body.toBuilder()
            additionalHeaders = transactionTypeCreateParams.additionalHeaders.toBuilder()
            additionalQueryParams = transactionTypeCreateParams.additionalQueryParams.toBuilder()
        }
        ...
        /**
         * Returns an immutable instance of [TransactionTypeCreateParams].
         *
         ...
         */
        fun build(): TransactionTypeCreateParams =
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return /* spotless:off */ other is TransactionTypeCreateParams && orgId == other.orgId && body == other.body && additionalHeaders == other.additionalHeaders && additionalQueryParams == other.additionalQueryParams /* spotless:on */
    }

    override fun hashCode(): Int = /* spotless:off */ Objects.hash(orgId, body, additionalHeaders, additionalQueryParams) /* spotless:on */

    override fun toString() =
        "TransactionTypeCreateParams{orgId=$orgId, body=$body, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
