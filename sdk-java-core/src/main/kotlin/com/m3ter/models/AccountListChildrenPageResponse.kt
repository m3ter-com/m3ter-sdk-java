...
class AccountListChildrenPageResponse
...
private constructor(
    ...
    companion object {
         ...
         * [AccountListChildrenPageResponse].
         */
        @JvmStatic fun builder() = Builder()
    }

    /** A builder for [AccountListChildrenPageResponse]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(accountListChildrenPageResponse: AccountListChildrenPageResponse) =
            apply {
                data = accountListChildrenPageResponse.data.map { it.toMutableList() }
                nextToken = accountListChildrenPageResponse.nextToken
                additionalProperties =
                    accountListChildrenPageResponse.additionalProperties.toMutableMap()
            }
        ...
        /**
         * Returns an immutable instance of [AccountListChildrenPageResponse].
         *
         * Further updates to this [Builder] will not mutate the returned instance.
         */
        fun build(): AccountListChildrenPageResponse =
            AccountListChildrenPageResponse(
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is AccountListChildrenPageResponse &&
            data == other.data &&
    ...
    override fun toString() =
        "AccountListChildrenPageResponse{data=$data, nextToken=$nextToken, additionalProperties=$additionalProperties}"
}
