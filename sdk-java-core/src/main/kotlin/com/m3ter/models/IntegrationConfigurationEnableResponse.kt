...
private constructor(
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is IntegrationConfigurationEnableResponse &&
            id == other.id &&
