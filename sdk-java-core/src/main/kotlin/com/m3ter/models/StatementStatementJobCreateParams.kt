 ...
 * - If you also want to generate the Statement in CSV format, use the `includeCsvFormat` request
 *   body parameter.
 ...
 */
class StatementStatementJobCreateParams
private constructor(
     ...
     */
    fun _billId(): JsonField<String> = body._billId()
    ...
    /** A builder for [StatementStatementJobCreateParams]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(statementStatementJobCreateParams: StatementStatementJobCreateParams) =
            apply {
                orgId = statementStatementJobCreateParams.orgId
                body = statementStatementJobCreateParams.body.toBuilder()
                additionalHeaders = statementStatementJobCreateParams.additionalHeaders.toBuilder()
                additionalQueryParams =
                    statementStatementJobCreateParams.additionalQueryParams.toBuilder()
            }
        ...
        /** The unique identifier (UUID) of the bill associated with the StatementJob. */
        fun billId(billId: String) = apply { body.billId(billId) }
         ...
         */
        fun billId(billId: JsonField<String>) = apply { body.billId(billId) }
        ...
        /**
         * Returns an immutable instance of [StatementStatementJobCreateParams].
         *
         ...
         */
        fun build(): StatementStatementJobCreateParams =
            StatementStatementJobCreateParams(
                orgId,
                body.build(),
    ...
    private constructor(
        ...
        class Builder internal constructor() {
            ...
            private var billId: JsonField<String>? = null
