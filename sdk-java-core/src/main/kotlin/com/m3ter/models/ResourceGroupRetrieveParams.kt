...
class ResourceGroupRetrieveParams
private constructor(
    ...
    /** A builder for [ResourceGroupRetrieveParams]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(resourceGroupRetrieveParams: ResourceGroupRetrieveParams) = apply {
            orgId = resourceGroupRetrieveParams.orgId
            type = resourceGroupRetrieveParams.type
            id = resourceGroupRetrieveParams.id
            additionalHeaders = resourceGroupRetrieveParams.additionalHeaders.toBuilder()
            additionalQueryParams = resourceGroupRetrieveParams.additionalQueryParams.toBuilder()
        }
        ...
        /**
         * Returns an immutable instance of [ResourceGroupRetrieveParams].
         *
         ...
         */
        fun build(): ResourceGroupRetrieveParams =
