...
class LookupTableLookupTableRevisionDataLookupTableRevisionDataJobListResponse
...
private constructor(
    ...
    /** A builder for [LookupTableLookupTableRevisionDataLookupTableRevisionDataJobListResponse]. */
    class Builder internal constructor() {
        ...
        internal fun from(
            ...
            id = lookupTableLookupTableRevisionDataLookupTableRevisionDataJobListResponse.id
            destinationLookupTableRevisionId =
                lookupTableLookupTableRevisionDataLookupTableRevisionDataJobListResponse
                    .destinationLookupTableRevisionId
            downloadUrl =
                lookupTableLookupTableRevisionDataLookupTableRevisionDataJobListResponse.downloadUrl
            downloadUrlExpiry =
                lookupTableLookupTableRevisionDataLookupTableRevisionDataJobListResponse
                    .downloadUrlExpiry
            failureReason =
            ...
            lookupTableRevisionId =
                lookupTableLookupTableRevisionDataLookupTableRevisionDataJobListResponse
                    .lookupTableRevisionId
            status = lookupTableLookupTableRevisionDataLookupTableRevisionDataJobListResponse.status
            type = lookupTableLookupTableRevisionDataLookupTableRevisionDataJobListResponse.type
            version =
         ...
         */
        fun build(): LookupTableLookupTableRevisionDataLookupTableRevisionDataJobListResponse =
            LookupTableLookupTableRevisionDataLookupTableRevisionDataJobListResponse(
                id,
                destinationLookupTableRevisionId,
                downloadUrl,
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is LookupTableLookupTableRevisionDataLookupTableRevisionDataJobListResponse &&
            id == other.id &&
