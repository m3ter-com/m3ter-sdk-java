...
private constructor(
    ...
    @JsonProperty("data")
    @ExcludeMissing
    fun _data(): JsonField<List<IntegrationConfigurationListResponse>> = data
    ...
    companion object {
         ...
         * [IntegrationConfigurationListPageResponse].
         */
        @JvmStatic fun builder() = Builder()
    }

    /** A builder for [IntegrationConfigurationListPageResponse]. */
    class Builder internal constructor() {

        private var data: JsonField<MutableList<IntegrationConfigurationListResponse>>? = null
        private var nextToken: JsonField<String> = JsonMissing.of()
        private var additionalProperties: MutableMap<String, JsonValue> = mutableMapOf()

        @JvmSynthetic
        internal fun from(
            integrationConfigurationListPageResponse: IntegrationConfigurationListPageResponse
        ) = apply {
            data = integrationConfigurationListPageResponse.data.map { it.toMutableList() }
            nextToken = integrationConfigurationListPageResponse.nextToken
         ...
         * `List<IntegrationConfigurationListResponse>` value instead. This method is primarily for
        ...
        /**
         * Adds a single [IntegrationConfigurationListResponse] to [Builder.data].
         *
         * @throws IllegalStateException if the field was previously set to a non-list.
         */
        fun addData(data: IntegrationConfigurationListResponse) = apply {
            this.data =
        ...
        /**
         * Returns an immutable instance of [IntegrationConfigurationListPageResponse].
         *
         * Further updates to this [Builder] will not mutate the returned instance.
         */
        fun build(): IntegrationConfigurationListPageResponse =
            IntegrationConfigurationListPageResponse(
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return /* spotless:off */ other is IntegrationConfigurationListPageResponse && data == other.data && nextToken == other.nextToken && additionalProperties == other.additionalProperties /* spotless:on */
    }
    ...
    override fun toString() =
        "IntegrationConfigurationListPageResponse{data=$data, nextToken=$nextToken, additionalProperties=$additionalProperties}"
}
