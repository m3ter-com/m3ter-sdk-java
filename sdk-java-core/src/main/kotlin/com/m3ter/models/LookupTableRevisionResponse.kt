...
class LookupTableRevisionResponse
...
private constructor(
    ...
    private val itemCount: JsonField<Long>,
    ...
    private constructor(
        ...
        @JsonProperty("itemCount") @ExcludeMissing itemCount: JsonField<Long> = JsonMissing.of(),
     ...
     *   server responded with an unexpected value).
     */
    fun itemCount(): Optional<Long> = itemCount.getOptional("itemCount")
    ...
    /**
     * Returns the raw JSON value of [itemCount].
     *
     * Unlike [itemCount], this method doesn't throw if the JSON field has an unexpected type.
     */
    @JsonProperty("itemCount") @ExcludeMissing fun _itemCount(): JsonField<Long> = itemCount
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [LookupTableRevisionResponse].
         *
    ...
    /** A builder for [LookupTableRevisionResponse]. */
    class Builder internal constructor() {
        ...
        private var itemCount: JsonField<Long> = JsonMissing.of()
        ...
        @JvmSynthetic
        internal fun from(lookupTableRevisionResponse: LookupTableRevisionResponse) = apply {
            id = lookupTableRevisionResponse.id
            createdBy = lookupTableRevisionResponse.createdBy
            customFields = lookupTableRevisionResponse.customFields
            dtCreated = lookupTableRevisionResponse.dtCreated
            dtLastModified = lookupTableRevisionResponse.dtLastModified
            fields = lookupTableRevisionResponse.fields.map { it.toMutableList() }
            itemCount = lookupTableRevisionResponse.itemCount
            keys = lookupTableRevisionResponse.keys.map { it.toMutableList() }
            lastModifiedBy = lookupTableRevisionResponse.lastModifiedBy
            name = lookupTableRevisionResponse.name
            startDate = lookupTableRevisionResponse.startDate
            status = lookupTableRevisionResponse.status
            version = lookupTableRevisionResponse.version
            additionalProperties = lookupTableRevisionResponse.additionalProperties.toMutableMap()
        }
        ...
        fun itemCount(itemCount: Long) = itemCount(JsonField.of(itemCount))

        /**
         * Sets [Builder.itemCount] to an arbitrary JSON value.
         *
         * You should usually call [Builder.itemCount] with a well-typed [Long] value instead. This
         * method is primarily for setting the field to an undocumented or not yet supported value.
         */
        fun itemCount(itemCount: JsonField<Long>) = apply { this.itemCount = itemCount }
        ...
        /**
         * Returns an immutable instance of [LookupTableRevisionResponse].
         *
         ...
         */
        fun build(): LookupTableRevisionResponse =
    ...
    internal fun validity(): Int =
        (if (id.asKnown().isPresent) 1 else 0) +
            ...
            (if (itemCount.asKnown().isPresent) 1 else 0) +
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is LookupTableRevisionResponse &&
            id == other.id &&
    ...
    override fun toString() =
        "LookupTableRevisionResponse{id=$id, createdBy=$createdBy, customFields=$customFields, dtCreated=$dtCreated, dtLastModified=$dtLastModified, fields=$fields, itemCount=$itemCount, keys=$keys, lastModifiedBy=$lastModifiedBy, name=$name, startDate=$startDate, status=$status, version=$version, additionalProperties=$additionalProperties}"
}
