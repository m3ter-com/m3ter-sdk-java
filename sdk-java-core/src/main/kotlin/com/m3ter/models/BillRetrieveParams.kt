...
private constructor(
    ...
    class Builder internal constructor() {
        ...
        fun build(): BillRetrieveParams =
            BillRetrieveParams(orgId, id, additionalHeaders.build(), additionalQueryParams.build())
    }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return /* spotless:off */ other is BillRetrieveParams && orgId == other.orgId && id == other.id && additionalHeaders == other.additionalHeaders && additionalQueryParams == other.additionalQueryParams /* spotless:on */
    }

    override fun hashCode(): Int = /* spotless:off */ Objects.hash(orgId, id, additionalHeaders, additionalQueryParams) /* spotless:on */

    override fun toString() =
        "BillRetrieveParams{orgId=$orgId, id=$id, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
