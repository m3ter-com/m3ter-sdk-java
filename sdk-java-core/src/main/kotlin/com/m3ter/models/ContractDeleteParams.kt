...
private constructor(
    ...
    companion object {
        ...
        /** Returns a mutable builder for constructing an instance of [ContractDeleteParams]. */
        @JvmStatic fun builder() = Builder()
    }

    /** A builder for [ContractDeleteParams]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(contractDeleteParams: ContractDeleteParams) = apply {
            orgId = contractDeleteParams.orgId
            id = contractDeleteParams.id
            additionalHeaders = contractDeleteParams.additionalHeaders.toBuilder()
            additionalQueryParams = contractDeleteParams.additionalQueryParams.toBuilder()
            additionalBodyProperties = contractDeleteParams.additionalBodyProperties.toMutableMap()
        }
        ...
        /**
         * Returns an immutable instance of [ContractDeleteParams].
         *
         * Further updates to this [Builder] will not mutate the returned instance.
         */
        fun build(): ContractDeleteParams =
