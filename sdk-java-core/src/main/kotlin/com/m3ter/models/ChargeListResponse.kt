...
private constructor(
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [ChargeListResponse].
         *
    ...
    /** A builder for [ChargeListResponse]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(chargeListResponse: ChargeListResponse) = apply {
            id = chargeListResponse.id
            accountId = chargeListResponse.accountId
            accountingProductId = chargeListResponse.accountingProductId
            amount = chargeListResponse.amount
            billDate = chargeListResponse.billDate
            billId = chargeListResponse.billId
            code = chargeListResponse.code
            contractId = chargeListResponse.contractId
            createdBy = chargeListResponse.createdBy
            currency = chargeListResponse.currency
            description = chargeListResponse.description
            dtCreated = chargeListResponse.dtCreated
            dtLastModified = chargeListResponse.dtLastModified
            entityId = chargeListResponse.entityId
            entityType = chargeListResponse.entityType
            lastModifiedBy = chargeListResponse.lastModifiedBy
            lineItemType = chargeListResponse.lineItemType
            name = chargeListResponse.name
            notes = chargeListResponse.notes
            scheduleId = chargeListResponse.scheduleId
            servicePeriodEndDate = chargeListResponse.servicePeriodEndDate
            servicePeriodStartDate = chargeListResponse.servicePeriodStartDate
            unitPrice = chargeListResponse.unitPrice
            units = chargeListResponse.units
            version = chargeListResponse.version
            additionalProperties = chargeListResponse.additionalProperties.toMutableMap()
        }
        ...
        /**
         * Returns an immutable instance of [ChargeListResponse].
         *
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is ChargeListResponse &&
            id == other.id &&
