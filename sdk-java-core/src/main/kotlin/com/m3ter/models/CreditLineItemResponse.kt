...
private constructor(
    ...
    class Builder internal constructor() {
        ...
        internal fun from(creditLineItemResponse: CreditLineItemResponse) = apply {
            ...
            lineItemType = creditLineItemResponse.lineItemType
    ...
    override fun toString() =
        "CreditLineItemResponse{id=$id, amount=$amount, createdBy=$createdBy, creditReasonId=$creditReasonId, description=$description, dtCreated=$dtCreated, dtLastModified=$dtLastModified, lastModifiedBy=$lastModifiedBy, lineItemType=$lineItemType, productId=$productId, referencedBillId=$referencedBillId, referencedLineItemId=$referencedLineItemId, servicePeriodEndDate=$servicePeriodEndDate, servicePeriodStartDate=$servicePeriodStartDate, version=$version, additionalProperties=$additionalProperties}"
}
