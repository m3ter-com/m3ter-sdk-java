...
private constructor(
     ...
     *   missing or null (e.g. if the server responded with an unexpected value).
     */
    fun daysBeforeBillDue(): Int = daysBeforeBillDue.getRequired("daysBeforeBillDue")
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [OrganizationConfigRequest].
         *
    ...
    /** A builder for [OrganizationConfigRequest]. */
    class Builder internal constructor() {

        private var currency: JsonField<String>? = null
        private var dayEpoch: JsonField<String>? = null
        private var daysBeforeBillDue: JsonField<Int>? = null
        ...
        @JvmSynthetic
        internal fun from(organizationConfigRequest: OrganizationConfigRequest) = apply {
            currency = organizationConfigRequest.currency
            dayEpoch = organizationConfigRequest.dayEpoch
            daysBeforeBillDue = organizationConfigRequest.daysBeforeBillDue
            monthEpoch = organizationConfigRequest.monthEpoch
            ...
            autoGenerateStatementMode = organizationConfigRequest.autoGenerateStatementMode
            billPrefix = organizationConfigRequest.billPrefix
            commitmentFeeBillInAdvance = organizationConfigRequest.commitmentFeeBillInAdvance
            consolidateBills = organizationConfigRequest.consolidateBills
            creditApplicationOrder =
                organizationConfigRequest.creditApplicationOrder.map { it.toMutableList() }
            currencyConversions =
                organizationConfigRequest.currencyConversions.map { it.toMutableList() }
            defaultStatementDefinitionId = organizationConfigRequest.defaultStatementDefinitionId
            ...
            version = organizationConfigRequest.version
            additionalProperties = organizationConfigRequest.additionalProperties.toMutableMap()
        }
        ...
        fun autoApproveBillsGracePeriodUnit(autoApproveBillsGracePeriodUnit: JsonField<String>) =
            apply {
                this.autoApproveBillsGracePeriodUnit = autoApproveBillsGracePeriodUnit
            }
        ...
        /**
         * Returns an immutable instance of [OrganizationConfigRequest].
         *
         ...
         */
        fun build(): OrganizationConfigRequest =
