 ...
 */
class TransactionTypeListParams
private constructor(
    ...
    companion object {
        ...
        @JvmStatic fun none(): TransactionTypeListParams = builder().build()

        /**
         * Returns a mutable builder for constructing an instance of [TransactionTypeListParams].
         */
    ...
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(transactionTypeListParams: TransactionTypeListParams) = apply {
            orgId = transactionTypeListParams.orgId
            archived = transactionTypeListParams.archived
            codes = transactionTypeListParams.codes?.toMutableList()
            ids = transactionTypeListParams.ids?.toMutableList()
            nextToken = transactionTypeListParams.nextToken
            pageSize = transactionTypeListParams.pageSize
            additionalHeaders = transactionTypeListParams.additionalHeaders.toBuilder()
            additionalQueryParams = transactionTypeListParams.additionalQueryParams.toBuilder()
        }
        ...
        /**
         * Returns an immutable instance of [TransactionTypeListParams].
         *
         * Further updates to this [Builder] will not mutate the returned instance.
         */
        fun build(): TransactionTypeListParams =
