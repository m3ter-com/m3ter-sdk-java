...
/**
 * Previews the Charges this Schedule would create, without persisting them. You can use this call
 * to obtain a preview of the Charges a Schedule you plan to create for a Balance would generate.
 */
class BalanceChargeSchedulePreviewParams
private constructor(
    ...
    companion object {
         ...
         * [BalanceChargeSchedulePreviewParams].
         *
    ...
    /** A builder for [BalanceChargeSchedulePreviewParams]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(balanceChargeSchedulePreviewParams: BalanceChargeSchedulePreviewParams) =
            apply {
                orgId = balanceChargeSchedulePreviewParams.orgId
                balanceId = balanceChargeSchedulePreviewParams.balanceId
                nextToken = balanceChargeSchedulePreviewParams.nextToken
                pageSize = balanceChargeSchedulePreviewParams.pageSize
                body = balanceChargeSchedulePreviewParams.body.toBuilder()
                additionalHeaders = balanceChargeSchedulePreviewParams.additionalHeaders.toBuilder()
                additionalQueryParams =
                    balanceChargeSchedulePreviewParams.additionalQueryParams.toBuilder()
            }
        ...
        /**
         * Returns an immutable instance of [BalanceChargeSchedulePreviewParams].
         *
         ...
         */
        fun build(): BalanceChargeSchedulePreviewParams =
            BalanceChargeSchedulePreviewParams(
                orgId,
                balanceId,
                nextToken,
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is BalanceChargeSchedulePreviewParams &&
            orgId == other.orgId &&
    ...
    override fun toString() =
        "BalanceChargeSchedulePreviewParams{orgId=$orgId, balanceId=$balanceId, nextToken=$nextToken, pageSize=$pageSize, body=$body, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
