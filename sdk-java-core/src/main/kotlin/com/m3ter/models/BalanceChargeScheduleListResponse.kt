...
class BalanceChargeScheduleListResponse
...
private constructor(
    ...
    /** A builder for [BalanceChargeScheduleListResponse]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(balanceChargeScheduleListResponse: BalanceChargeScheduleListResponse) =
            apply {
                id = balanceChargeScheduleListResponse.id
                chargeDescription = balanceChargeScheduleListResponse.chargeDescription
                amount = balanceChargeScheduleListResponse.amount
                balanceId = balanceChargeScheduleListResponse.balanceId
                billEpoch = balanceChargeScheduleListResponse.billEpoch
                billFrequency = balanceChargeScheduleListResponse.billFrequency
                billFrequencyInterval = balanceChargeScheduleListResponse.billFrequencyInterval
                billInAdvance = balanceChargeScheduleListResponse.billInAdvance
                code = balanceChargeScheduleListResponse.code
                createdBy = balanceChargeScheduleListResponse.createdBy
                currency = balanceChargeScheduleListResponse.currency
                customFields = balanceChargeScheduleListResponse.customFields
                dtCreated = balanceChargeScheduleListResponse.dtCreated
                dtLastModified = balanceChargeScheduleListResponse.dtLastModified
                lastModifiedBy = balanceChargeScheduleListResponse.lastModifiedBy
                name = balanceChargeScheduleListResponse.name
                nextRun = balanceChargeScheduleListResponse.nextRun
                previousRun = balanceChargeScheduleListResponse.previousRun
                servicePeriodEndDate = balanceChargeScheduleListResponse.servicePeriodEndDate
                servicePeriodStartDate = balanceChargeScheduleListResponse.servicePeriodStartDate
                unitPrice = balanceChargeScheduleListResponse.unitPrice
                units = balanceChargeScheduleListResponse.units
                version = balanceChargeScheduleListResponse.version
                additionalProperties =
                    balanceChargeScheduleListResponse.additionalProperties.toMutableMap()
            }
        ...
        /**
         * Returns an immutable instance of [BalanceChargeScheduleListResponse].
         *
         ...
         */
        fun build(): BalanceChargeScheduleListResponse =
            BalanceChargeScheduleListResponse(
                checkRequired("id", id),
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is BalanceChargeScheduleListResponse &&
            id == other.id &&
