...
private constructor(
    ...
    companion object {
        ...
        @JvmStatic fun none(): BalanceRetrieveParams = builder().build()
    ...
    class Builder internal constructor() {
        ...
        internal fun from(balanceRetrieveParams: BalanceRetrieveParams) = apply {
            orgId = balanceRetrieveParams.orgId
            id = balanceRetrieveParams.id
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return /* spotless:off */ other is BalanceRetrieveParams && orgId == other.orgId && id == other.id && additionalHeaders == other.additionalHeaders && additionalQueryParams == other.additionalQueryParams /* spotless:on */
    }

    override fun hashCode(): Int = /* spotless:off */ Objects.hash(orgId, id, additionalHeaders, additionalQueryParams) /* spotless:on */

    override fun toString() =
        "BalanceRetrieveParams{orgId=$orgId, id=$id, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
