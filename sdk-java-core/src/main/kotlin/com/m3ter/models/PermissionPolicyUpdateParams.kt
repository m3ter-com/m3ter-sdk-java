 ...
 *
 * **NOTE:** When you set up a policy statement for this call to specify the `effect`, `action`, and
 * `resource`, you must use all lower case and the format as shown in this example - a Permission
 * Policy statement that grants full CRUD access to all meters:
 * ```
 * "permissionPolicy" : [
 * 	{
 * 		"effect" : "allow",
...
private constructor(
    ...
    /** A builder for [PermissionPolicyUpdateParams]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(permissionPolicyUpdateParams: PermissionPolicyUpdateParams) = apply {
            orgId = permissionPolicyUpdateParams.orgId
            id = permissionPolicyUpdateParams.id
            body = permissionPolicyUpdateParams.body.toBuilder()
            additionalHeaders = permissionPolicyUpdateParams.additionalHeaders.toBuilder()
            additionalQueryParams = permissionPolicyUpdateParams.additionalQueryParams.toBuilder()
        }
        ...
        /**
         * Returns an immutable instance of [PermissionPolicyUpdateParams].
         *
    ...
    private constructor(
        ...
        ) : this(name, permissionPolicy, version, mutableMapOf())
