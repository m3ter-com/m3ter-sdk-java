...
class BalanceChargeScheduleRetrieveResponse
...
private constructor(
    ...
    /** A builder for [BalanceChargeScheduleRetrieveResponse]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(
            balanceChargeScheduleRetrieveResponse: BalanceChargeScheduleRetrieveResponse
        ) = apply {
            id = balanceChargeScheduleRetrieveResponse.id
            chargeDescription = balanceChargeScheduleRetrieveResponse.chargeDescription
            amount = balanceChargeScheduleRetrieveResponse.amount
            balanceId = balanceChargeScheduleRetrieveResponse.balanceId
            billEpoch = balanceChargeScheduleRetrieveResponse.billEpoch
            billFrequency = balanceChargeScheduleRetrieveResponse.billFrequency
            billFrequencyInterval = balanceChargeScheduleRetrieveResponse.billFrequencyInterval
            billInAdvance = balanceChargeScheduleRetrieveResponse.billInAdvance
            code = balanceChargeScheduleRetrieveResponse.code
            createdBy = balanceChargeScheduleRetrieveResponse.createdBy
            currency = balanceChargeScheduleRetrieveResponse.currency
            customFields = balanceChargeScheduleRetrieveResponse.customFields
            dtCreated = balanceChargeScheduleRetrieveResponse.dtCreated
            dtLastModified = balanceChargeScheduleRetrieveResponse.dtLastModified
            lastModifiedBy = balanceChargeScheduleRetrieveResponse.lastModifiedBy
            name = balanceChargeScheduleRetrieveResponse.name
            nextRun = balanceChargeScheduleRetrieveResponse.nextRun
            previousRun = balanceChargeScheduleRetrieveResponse.previousRun
            servicePeriodEndDate = balanceChargeScheduleRetrieveResponse.servicePeriodEndDate
            servicePeriodStartDate = balanceChargeScheduleRetrieveResponse.servicePeriodStartDate
            unitPrice = balanceChargeScheduleRetrieveResponse.unitPrice
            units = balanceChargeScheduleRetrieveResponse.units
            version = balanceChargeScheduleRetrieveResponse.version
            additionalProperties =
                balanceChargeScheduleRetrieveResponse.additionalProperties.toMutableMap()
        }
        ...
        /**
         * Returns an immutable instance of [BalanceChargeScheduleRetrieveResponse].
         *
         ...
         */
        fun build(): BalanceChargeScheduleRetrieveResponse =
            BalanceChargeScheduleRetrieveResponse(
                checkRequired("id", id),
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is BalanceChargeScheduleRetrieveResponse &&
            id == other.id &&
