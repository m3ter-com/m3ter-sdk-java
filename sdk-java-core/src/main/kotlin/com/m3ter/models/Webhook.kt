...
private constructor(
    ...
    private val credentials: JsonField<M3terSignedCredentialsResponse>,
    ...
    private constructor(
        ...
        @ExcludeMissing
        credentials: JsonField<M3terSignedCredentialsResponse> = JsonMissing.of(),
    ...
    fun credentials(): Optional<M3terSignedCredentialsResponse> =
        credentials.getOptional("credentials")
    ...
    class Builder internal constructor() {
         ...
         * [M3terSignedCredentialsResponse] value instead. This method is primarily for setting the
    ...
    override fun toString() =
        "Webhook{id=$id, active=$active, code=$code, createdBy=$createdBy, credentials=$credentials, description=$description, dtCreated=$dtCreated, dtLastModified=$dtLastModified, lastModifiedBy=$lastModifiedBy, name=$name, url=$url, version=$version, additionalProperties=$additionalProperties}"
}
