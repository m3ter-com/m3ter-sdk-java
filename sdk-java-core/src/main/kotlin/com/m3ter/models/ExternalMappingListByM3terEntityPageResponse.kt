...
private constructor(
    ...
    companion object {
         ...
         * [ExternalMappingListByM3terEntityPageResponse].
         */
        @JvmStatic fun builder() = Builder()
    }

    /** A builder for [ExternalMappingListByM3terEntityPageResponse]. */
    class Builder internal constructor() {
        ...
        internal fun from(
            ...
            data = externalMappingListByM3terEntityPageResponse.data.map { it.toMutableList() }
            nextToken = externalMappingListByM3terEntityPageResponse.nextToken
            additionalProperties =
                externalMappingListByM3terEntityPageResponse.additionalProperties.toMutableMap()
        }
        ...
        /**
         * Returns an immutable instance of [ExternalMappingListByM3terEntityPageResponse].
         *
         * Further updates to this [Builder] will not mutate the returned instance.
         */
        fun build(): ExternalMappingListByM3terEntityPageResponse =
            ExternalMappingListByM3terEntityPageResponse(
    ...
    override fun toString() =
        "ExternalMappingListByM3terEntityPageResponse{data=$data, nextToken=$nextToken, additionalProperties=$additionalProperties}"
}
