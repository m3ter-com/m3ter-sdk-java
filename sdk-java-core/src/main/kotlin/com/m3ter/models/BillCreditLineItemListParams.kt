...
class BillCreditLineItemListParams
private constructor(
    ...
    companion object {
        ...
        @JvmStatic fun none(): BillCreditLineItemListParams = builder().build()

        /**
         * Returns a mutable builder for constructing an instance of [BillCreditLineItemListParams].
         */
        @JvmStatic fun builder() = Builder()
    }

    /** A builder for [BillCreditLineItemListParams]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(billCreditLineItemListParams: BillCreditLineItemListParams) = apply {
            orgId = billCreditLineItemListParams.orgId
            billId = billCreditLineItemListParams.billId
            nextToken = billCreditLineItemListParams.nextToken
            pageSize = billCreditLineItemListParams.pageSize
            additionalHeaders = billCreditLineItemListParams.additionalHeaders.toBuilder()
            additionalQueryParams = billCreditLineItemListParams.additionalQueryParams.toBuilder()
        }
        ...
        /**
         * Returns an immutable instance of [BillCreditLineItemListParams].
         *
         * Further updates to this [Builder] will not mutate the returned instance.
         */
        fun build(): BillCreditLineItemListParams =
            BillCreditLineItemListParams(
                orgId,
                billId,
                nextToken,
                pageSize,
