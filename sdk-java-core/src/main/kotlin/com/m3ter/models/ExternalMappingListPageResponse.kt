...
class ExternalMappingListPageResponse
private constructor(
    ...
    companion object {
         ...
         * [ExternalMappingListPageResponse].
         */
        @JvmStatic fun builder() = Builder()
    }

    /** A builder for [ExternalMappingListPageResponse]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(externalMappingListPageResponse: ExternalMappingListPageResponse) =
            apply {
                data = externalMappingListPageResponse.data.map { it.toMutableList() }
                nextToken = externalMappingListPageResponse.nextToken
        ...
        /**
         * Returns an immutable instance of [ExternalMappingListPageResponse].
         *
         * Further updates to this [Builder] will not mutate the returned instance.
         */
        fun build(): ExternalMappingListPageResponse =
            ExternalMappingListPageResponse(
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return /* spotless:off */ other is ExternalMappingListPageResponse && data == other.data && nextToken == other.nextToken && additionalProperties == other.additionalProperties /* spotless:on */
    }
    ...
    override fun toString() =
        "ExternalMappingListPageResponse{data=$data, nextToken=$nextToken, additionalProperties=$additionalProperties}"
}
