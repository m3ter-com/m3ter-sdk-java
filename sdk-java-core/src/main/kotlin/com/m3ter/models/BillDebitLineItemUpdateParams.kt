...
class BillDebitLineItemUpdateParams
private constructor(
    ...
    /** A builder for [BillDebitLineItemUpdateParams]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(billDebitLineItemUpdateParams: BillDebitLineItemUpdateParams) = apply {
            orgId = billDebitLineItemUpdateParams.orgId
            billId = billDebitLineItemUpdateParams.billId
            id = billDebitLineItemUpdateParams.id
            body = billDebitLineItemUpdateParams.body.toBuilder()
            additionalHeaders = billDebitLineItemUpdateParams.additionalHeaders.toBuilder()
        ...
        /**
         * Returns an immutable instance of [BillDebitLineItemUpdateParams].
         *
         ...
         */
        fun build(): BillDebitLineItemUpdateParams =
            BillDebitLineItemUpdateParams(
                orgId,
    ...
    private constructor(
        ...
        class Builder internal constructor() {
             ...
             * Sets [Builder.debitReasonId] to an arbitrary JSON value.
             *
             * You should usually call [Builder.debitReasonId] with a well-typed [String] value
             * instead. This method is primarily for setting the field to an undocumented or not yet
             * supported value.
             */
            fun debitReasonId(debitReasonId: JsonField<String>) = apply {
