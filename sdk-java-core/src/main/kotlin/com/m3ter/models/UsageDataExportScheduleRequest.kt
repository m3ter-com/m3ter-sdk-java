...
private constructor(
    ...
    /** A builder for [UsageDataExportScheduleRequest]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(usageDataExportScheduleRequest: UsageDataExportScheduleRequest) = apply {
            aggregationFrequency = usageDataExportScheduleRequest.aggregationFrequency
            sourceType = usageDataExportScheduleRequest.sourceType
            timePeriod = usageDataExportScheduleRequest.timePeriod
            accountIds = usageDataExportScheduleRequest.accountIds.map { it.toMutableList() }
            aggregation = usageDataExportScheduleRequest.aggregation
            meterIds = usageDataExportScheduleRequest.meterIds.map { it.toMutableList() }
            version = usageDataExportScheduleRequest.version
            additionalProperties =
                usageDataExportScheduleRequest.additionalProperties.toMutableMap()
        }
        ...
        /**
         * Returns an immutable instance of [UsageDataExportScheduleRequest].
         *
         ...
         */
        fun build(): UsageDataExportScheduleRequest =
            UsageDataExportScheduleRequest(
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return /* spotless:off */ other is UsageDataExportScheduleRequest && aggregationFrequency == other.aggregationFrequency && sourceType == other.sourceType && timePeriod == other.timePeriod && accountIds == other.accountIds && aggregation == other.aggregation && meterIds == other.meterIds && version == other.version && additionalProperties == other.additionalProperties /* spotless:on */
    }
    ...
    override fun toString() =
        "UsageDataExportScheduleRequest{aggregationFrequency=$aggregationFrequency, sourceType=$sourceType, timePeriod=$timePeriod, accountIds=$accountIds, aggregation=$aggregation, meterIds=$meterIds, version=$version, additionalProperties=$additionalProperties}"
}
