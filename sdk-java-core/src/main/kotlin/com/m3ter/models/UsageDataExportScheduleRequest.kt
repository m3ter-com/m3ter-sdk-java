...
private constructor(
    ...
    class Builder internal constructor() {
        ...
        internal fun from(usageDataExportScheduleRequest: UsageDataExportScheduleRequest) = apply {
            ...
            aggregations = usageDataExportScheduleRequest.aggregations.map { it.toMutableList() }
            dimensionFilters =
                usageDataExportScheduleRequest.dimensionFilters.map { it.toMutableList() }
            groups = usageDataExportScheduleRequest.groups.map { it.toMutableList() }
    ...
    override fun toString() =
        "UsageDataExportScheduleRequest{sourceType=$sourceType, timePeriod=$timePeriod, accountIds=$accountIds, aggregations=$aggregations, dimensionFilters=$dimensionFilters, groups=$groups, meterIds=$meterIds, version=$version, additionalProperties=$additionalProperties}"
}
