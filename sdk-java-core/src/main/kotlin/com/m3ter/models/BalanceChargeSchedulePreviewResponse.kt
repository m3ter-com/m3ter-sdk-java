...
class BalanceChargeSchedulePreviewResponse
...
private constructor(
    ...
    /** A builder for [BalanceChargeSchedulePreviewResponse]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(
            balanceChargeSchedulePreviewResponse: BalanceChargeSchedulePreviewResponse
        ) = apply {
            id = balanceChargeSchedulePreviewResponse.id
            chargeDescription = balanceChargeSchedulePreviewResponse.chargeDescription
            amount = balanceChargeSchedulePreviewResponse.amount
            balanceId = balanceChargeSchedulePreviewResponse.balanceId
            billEpoch = balanceChargeSchedulePreviewResponse.billEpoch
            billFrequency = balanceChargeSchedulePreviewResponse.billFrequency
            billFrequencyInterval = balanceChargeSchedulePreviewResponse.billFrequencyInterval
            billInAdvance = balanceChargeSchedulePreviewResponse.billInAdvance
            code = balanceChargeSchedulePreviewResponse.code
            createdBy = balanceChargeSchedulePreviewResponse.createdBy
            currency = balanceChargeSchedulePreviewResponse.currency
            customFields = balanceChargeSchedulePreviewResponse.customFields
            dtCreated = balanceChargeSchedulePreviewResponse.dtCreated
            dtLastModified = balanceChargeSchedulePreviewResponse.dtLastModified
            lastModifiedBy = balanceChargeSchedulePreviewResponse.lastModifiedBy
            name = balanceChargeSchedulePreviewResponse.name
            nextRun = balanceChargeSchedulePreviewResponse.nextRun
            previousRun = balanceChargeSchedulePreviewResponse.previousRun
            servicePeriodEndDate = balanceChargeSchedulePreviewResponse.servicePeriodEndDate
            servicePeriodStartDate = balanceChargeSchedulePreviewResponse.servicePeriodStartDate
            unitPrice = balanceChargeSchedulePreviewResponse.unitPrice
            units = balanceChargeSchedulePreviewResponse.units
            version = balanceChargeSchedulePreviewResponse.version
            additionalProperties =
                balanceChargeSchedulePreviewResponse.additionalProperties.toMutableMap()
        }
        ...
        /**
         * Returns an immutable instance of [BalanceChargeSchedulePreviewResponse].
         *
         ...
         */
        fun build(): BalanceChargeSchedulePreviewResponse =
            BalanceChargeSchedulePreviewResponse(
                checkRequired("id", id),
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is BalanceChargeSchedulePreviewResponse &&
            id == other.id &&
