 ...
 *
 * This endpoint executes a search query for Bills based on the user specified search criteria. The
 * search query is customizable, allowing for complex nested conditions and sorting. The returned
 * list of Bills can be paginated for easier management.
 */
...
private constructor(
     ...
     *     - This query is translated into: find Bills that startDate is older than 2023-01-01 AND
     *       accountId is equal to 62eaad67-5790-407e-b853-881564f0e543.
     *
    ...
    /**
     * Name of the parameter on which sorting is performed. Use any field available on the Bill
     * entity to sort by, such as `accountId`, `endDate`, and so on.
     */
    ...
    companion object {
        ...
        @JvmStatic fun none(): BillSearchParams = builder().build()

        /** Returns a mutable builder for constructing an instance of [BillSearchParams]. */
        @JvmStatic fun builder() = Builder()
    }

    /** A builder for [BillSearchParams]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(billSearchParams: BillSearchParams) = apply {
            orgId = billSearchParams.orgId
            fromDocument = billSearchParams.fromDocument
            operator = billSearchParams.operator
            pageSize = billSearchParams.pageSize
            searchQuery = billSearchParams.searchQuery
            sortBy = billSearchParams.sortBy
            sortOrder = billSearchParams.sortOrder
            additionalHeaders = billSearchParams.additionalHeaders.toBuilder()
         ...
         * - Query example:
         *     - searchQuery=startDate>2023-01-01$accountId:62eaad67-5790-407e-b853-881564f0e543.
         *     - This query is translated into: find Bills that startDate is older than 2023-01-01
         *       AND accountId is equal to 62eaad67-5790-407e-b853-881564f0e543.
         *
        ...
        /**
         * Returns an immutable instance of [BillSearchParams].
         *
         * Further updates to this [Builder] will not mutate the returned instance.
         */
        fun build(): BillSearchParams =
            BillSearchParams(
                orgId,
                fromDocument,
                operator,
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return /* spotless:off */ other is BillSearchParams && orgId == other.orgId && fromDocument == other.fromDocument && operator == other.operator && pageSize == other.pageSize && searchQuery == other.searchQuery && sortBy == other.sortBy && sortOrder == other.sortOrder && additionalHeaders == other.additionalHeaders && additionalQueryParams == other.additionalQueryParams /* spotless:on */
    }
    ...
    override fun toString() =
        "BillSearchParams{orgId=$orgId, fromDocument=$fromDocument, operator=$operator, pageSize=$pageSize, searchQuery=$searchQuery, sortBy=$sortBy, sortOrder=$sortOrder, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
