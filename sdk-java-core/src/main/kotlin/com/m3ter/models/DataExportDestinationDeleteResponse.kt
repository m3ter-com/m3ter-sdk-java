...
@JsonDeserialize(using = DataExportDestinationDeleteResponse.Deserializer::class)
@JsonSerialize(using = DataExportDestinationDeleteResponse.Serializer::class)
class DataExportDestinationDeleteResponse
private constructor(
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return /* spotless:off */ other is DataExportDestinationDeleteResponse && exportDestinationS3 == other.exportDestinationS3 && exportDestinationGoogleCloudStorage == other.exportDestinationGoogleCloudStorage /* spotless:on */
    }
    ...
    override fun toString(): String =
        when {
            exportDestinationS3 != null ->
                "DataExportDestinationDeleteResponse{exportDestinationS3=$exportDestinationS3}"
            exportDestinationGoogleCloudStorage != null ->
                "DataExportDestinationDeleteResponse{exportDestinationGoogleCloudStorage=$exportDestinationGoogleCloudStorage}"
            _json != null -> "DataExportDestinationDeleteResponse{_unknown=$_json}"
            else -> throw IllegalStateException("Invalid DataExportDestinationDeleteResponse")
        }
    ...
    /**
     * An interface that defines how to map each variant of [DataExportDestinationDeleteResponse] to
     * a value of type [T].
     */
    interface Visitor<out T> {
        ...
        /**
         * Maps an unknown variant of [DataExportDestinationDeleteResponse] to a value of type [T].
         *
         * An instance of [DataExportDestinationDeleteResponse] can contain an unknown variant if it
        ...
        fun unknown(json: JsonValue?): T {
            throw M3terInvalidDataException("Unknown DataExportDestinationDeleteResponse: $json")
        }
    }

    internal class Deserializer :
        BaseDeserializer<DataExportDestinationDeleteResponse>(
            DataExportDestinationDeleteResponse::class
        ) {
        ...
        override fun ObjectCodec.deserialize(node: JsonNode): DataExportDestinationDeleteResponse {
            ...
            return when (bestMatches.size) {
                ...
                0 -> DataExportDestinationDeleteResponse(_json = json)
    ...
    internal class Serializer :
        BaseSerializer<DataExportDestinationDeleteResponse>(
            DataExportDestinationDeleteResponse::class
        ) {

        override fun serialize(
            value: DataExportDestinationDeleteResponse,
