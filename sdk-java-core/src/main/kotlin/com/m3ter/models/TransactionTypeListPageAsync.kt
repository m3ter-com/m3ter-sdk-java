...
private constructor(
    ...
    fun data(): List<TransactionTypeResponse> = response().data()
    ...
    class Response(
        ...
        @JsonCreator
        private constructor(
            @JsonProperty("data") data: JsonField<List<TransactionTypeResponse>> = JsonMissing.of(),
            @JsonProperty("nextToken") nextToken: JsonField<String> = JsonMissing.of(),
        ) : this(data, nextToken, mutableMapOf())

        fun data(): List<TransactionTypeResponse> = data.getOptional("data").getOrNull() ?: listOf()

        fun nextToken(): Optional<String> = nextToken.getOptional("nextToken")

        @JsonProperty("data")
        fun _data(): Optional<JsonField<List<TransactionTypeResponse>>> = Optional.ofNullable(data)
        ...
        class Builder {
            ...
            private var data: JsonField<List<TransactionTypeResponse>> = JsonMissing.of()
            ...
            fun data(data: JsonField<List<TransactionTypeResponse>>) = apply { this.data = data }
