...
private constructor(
    ...
    private constructor(
        @JsonProperty("data")
        @ExcludeMissing
        data: JsonField<List<TransactionResponse>> = JsonMissing.of(),
     ...
     */
    @JsonProperty("data") @ExcludeMissing fun _data(): JsonField<List<TransactionResponse>> = data
    ...
    /** A builder for [BalanceTransactionListPageResponse]. */
    class Builder internal constructor() {

        private var data: JsonField<MutableList<TransactionResponse>>? = null
        private var nextToken: JsonField<String> = JsonMissing.of()
        private var additionalProperties: MutableMap<String, JsonValue> = mutableMapOf()

        @JvmSynthetic
        internal fun from(balanceTransactionListPageResponse: BalanceTransactionListPageResponse) =
            apply {
                data = balanceTransactionListPageResponse.data.map { it.toMutableList() }
                nextToken = balanceTransactionListPageResponse.nextToken
         ...
         *
         * You should usually call [Builder.data] with a well-typed `List<TransactionResponse>`
         * value instead. This method is primarily for setting the field to an undocumented or not
         * yet supported value.
         */
        fun data(data: JsonField<List<TransactionResponse>>) = apply {
            this.data = data.map { it.toMutableList() }
        }

        /**
         * Adds a single [TransactionResponse] to [Builder.data].
         *
         * @throws IllegalStateException if the field was previously set to a non-list.
         */
        fun addData(data: TransactionResponse) = apply {
            this.data =
        ...
        /**
         * Returns an immutable instance of [BalanceTransactionListPageResponse].
         *
         * Further updates to this [Builder] will not mutate the returned instance.
         */
        fun build(): BalanceTransactionListPageResponse =
            BalanceTransactionListPageResponse(
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return /* spotless:off */ other is BalanceTransactionListPageResponse && data == other.data && nextToken == other.nextToken && additionalProperties == other.additionalProperties /* spotless:on */
    }
    ...
    override fun toString() =
        "BalanceTransactionListPageResponse{data=$data, nextToken=$nextToken, additionalProperties=$additionalProperties}"
}
