 ...
 *
 * This endpoint modifies the configuration details of an existing Notification. You can change the
 * Event that triggers the Notification and/or update the conditions for sending the Notification.
 */
...
private constructor(
    ...
    /** A builder for [NotificationConfigurationUpdateParams]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(
            notificationConfigurationUpdateParams: NotificationConfigurationUpdateParams
        ) = apply {
            orgId = notificationConfigurationUpdateParams.orgId
            id = notificationConfigurationUpdateParams.id
            body = notificationConfigurationUpdateParams.body.toBuilder()
            additionalHeaders = notificationConfigurationUpdateParams.additionalHeaders.toBuilder()
            additionalQueryParams =
                notificationConfigurationUpdateParams.additionalQueryParams.toBuilder()
        }
        ...
        /**
         * Returns an immutable instance of [NotificationConfigurationUpdateParams].
         *
