...
private constructor(
    ...
    class Builder internal constructor() {
        ...
        internal fun from(userRetrieveParams: UserRetrieveParams) = apply {
            orgId = userRetrieveParams.orgId
        ...
        fun build(): UserRetrieveParams =
            UserRetrieveParams(orgId, id, additionalHeaders.build(), additionalQueryParams.build())
    }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return /* spotless:off */ other is UserRetrieveParams && orgId == other.orgId && id == other.id && additionalHeaders == other.additionalHeaders && additionalQueryParams == other.additionalQueryParams /* spotless:on */
    }

    override fun hashCode(): Int = /* spotless:off */ Objects.hash(orgId, id, additionalHeaders, additionalQueryParams) /* spotless:on */

    override fun toString() =
        "UserRetrieveParams{orgId=$orgId, id=$id, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
