...
class LookupTableLookupTableRevisionDataDeleteResponse
...
private constructor(
    ...
    /** A builder for [LookupTableLookupTableRevisionDataDeleteResponse]. */
    class Builder internal constructor() {
        ...
        internal fun from(
            ...
            result = lookupTableLookupTableRevisionDataDeleteResponse.result
            additionalProperties =
                lookupTableLookupTableRevisionDataDeleteResponse.additionalProperties.toMutableMap()
        }
        ...
        /**
         * Returns an immutable instance of [LookupTableLookupTableRevisionDataDeleteResponse].
         *
         * Further updates to this [Builder] will not mutate the returned instance.
         */
        fun build(): LookupTableLookupTableRevisionDataDeleteResponse =
            LookupTableLookupTableRevisionDataDeleteResponse(
                result,
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is LookupTableLookupTableRevisionDataDeleteResponse &&
            result == other.result &&
    ...
    override fun toString() =
        "LookupTableLookupTableRevisionDataDeleteResponse{result=$result, additionalProperties=$additionalProperties}"
}
