...
private constructor(
    ...
    /** A builder for [WebhookSetActiveParams]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(webhookSetActiveParams: WebhookSetActiveParams) = apply {
            orgId = webhookSetActiveParams.orgId
            id = webhookSetActiveParams.id
            active = webhookSetActiveParams.active
            additionalHeaders = webhookSetActiveParams.additionalHeaders.toBuilder()
            additionalQueryParams = webhookSetActiveParams.additionalQueryParams.toBuilder()
