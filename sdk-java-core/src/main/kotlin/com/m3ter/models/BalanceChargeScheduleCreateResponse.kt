...
class BalanceChargeScheduleCreateResponse
...
private constructor(
    ...
    /** A builder for [BalanceChargeScheduleCreateResponse]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(
            balanceChargeScheduleCreateResponse: BalanceChargeScheduleCreateResponse
        ) = apply {
            id = balanceChargeScheduleCreateResponse.id
            chargeDescription = balanceChargeScheduleCreateResponse.chargeDescription
            amount = balanceChargeScheduleCreateResponse.amount
            balanceId = balanceChargeScheduleCreateResponse.balanceId
            billEpoch = balanceChargeScheduleCreateResponse.billEpoch
            billFrequency = balanceChargeScheduleCreateResponse.billFrequency
            billFrequencyInterval = balanceChargeScheduleCreateResponse.billFrequencyInterval
            billInAdvance = balanceChargeScheduleCreateResponse.billInAdvance
            code = balanceChargeScheduleCreateResponse.code
            createdBy = balanceChargeScheduleCreateResponse.createdBy
            currency = balanceChargeScheduleCreateResponse.currency
            customFields = balanceChargeScheduleCreateResponse.customFields
            dtCreated = balanceChargeScheduleCreateResponse.dtCreated
            dtLastModified = balanceChargeScheduleCreateResponse.dtLastModified
            lastModifiedBy = balanceChargeScheduleCreateResponse.lastModifiedBy
            name = balanceChargeScheduleCreateResponse.name
            nextRun = balanceChargeScheduleCreateResponse.nextRun
            previousRun = balanceChargeScheduleCreateResponse.previousRun
            servicePeriodEndDate = balanceChargeScheduleCreateResponse.servicePeriodEndDate
            servicePeriodStartDate = balanceChargeScheduleCreateResponse.servicePeriodStartDate
            unitPrice = balanceChargeScheduleCreateResponse.unitPrice
            units = balanceChargeScheduleCreateResponse.units
            version = balanceChargeScheduleCreateResponse.version
            additionalProperties =
                balanceChargeScheduleCreateResponse.additionalProperties.toMutableMap()
        }
        ...
        /**
         * Returns an immutable instance of [BalanceChargeScheduleCreateResponse].
         *
         ...
         */
        fun build(): BalanceChargeScheduleCreateResponse =
            BalanceChargeScheduleCreateResponse(
                checkRequired("id", id),
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is BalanceChargeScheduleCreateResponse &&
            id == other.id &&
