...
private constructor(
    ...
    private constructor(
        @JsonProperty("data")
        @ExcludeMissing
        data: JsonField<List<ContractResponse>> = JsonMissing.of(),
        @JsonProperty("nextToken") @ExcludeMissing nextToken: JsonField<String> = JsonMissing.of(),
    ) : this(data, nextToken, mutableMapOf())

    /**
     * The list of Contract information.
     *
     * @throws M3terInvalidDataException if the JSON field has an unexpected type (e.g. if the
     *   server responded with an unexpected value).
     */
    fun data(): Optional<List<ContractResponse>> = data.getOptional("data")
     ...
     */
    @JsonProperty("data") @ExcludeMissing fun _data(): JsonField<List<ContractResponse>> = data
    ...
    class Builder internal constructor() {
        ...
        private var data: JsonField<MutableList<ContractResponse>>? = null
        ...
        internal fun from(contractListPageResponse: ContractListPageResponse) = apply {
            ...
            nextToken = contractListPageResponse.nextToken
         ...
         *
         * You should usually call [Builder.data] with a well-typed `List<ContractResponse>` value
         * instead. This method is primarily for setting the field to an undocumented or not yet
         * supported value.
         */
        fun data(data: JsonField<List<ContractResponse>>) = apply {
            this.data = data.map { it.toMutableList() }
        }

        /**
         * Adds a single [ContractResponse] to [Builder.data].
         *
         * @throws IllegalStateException if the field was previously set to a non-list.
         */
        fun addData(data: ContractResponse) = apply {
            this.data =
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return /* spotless:off */ other is ContractListPageResponse && data == other.data && nextToken == other.nextToken && additionalProperties == other.additionalProperties /* spotless:on */
    }
    ...
    override fun toString() =
        "ContractListPageResponse{data=$data, nextToken=$nextToken, additionalProperties=$additionalProperties}"
}
