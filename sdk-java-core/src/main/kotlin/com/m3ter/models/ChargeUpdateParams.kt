...
private constructor(
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [ChargeUpdateParams].
         *
    ...
    /** A builder for [ChargeUpdateParams]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(chargeUpdateParams: ChargeUpdateParams) = apply {
            orgId = chargeUpdateParams.orgId
            id = chargeUpdateParams.id
            body = chargeUpdateParams.body.toBuilder()
            additionalHeaders = chargeUpdateParams.additionalHeaders.toBuilder()
            additionalQueryParams = chargeUpdateParams.additionalQueryParams.toBuilder()
        }
        ...
        /**
         * Returns an immutable instance of [ChargeUpdateParams].
         *
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is ChargeUpdateParams &&
            orgId == other.orgId &&
            id == other.id &&
            body == other.body &&
    ...
    override fun toString() =
        "ChargeUpdateParams{orgId=$orgId, id=$id, body=$body, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
