 ...
 */
class LookupTableLookupTableRevisionUpdateParams
private constructor(
    ...
    companion object {
         ...
         * [LookupTableLookupTableRevisionUpdateParams].
         *
    ...
    /** A builder for [LookupTableLookupTableRevisionUpdateParams]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(
            lookupTableLookupTableRevisionUpdateParams: LookupTableLookupTableRevisionUpdateParams
        ) = apply {
            orgId = lookupTableLookupTableRevisionUpdateParams.orgId
            lookupTableId = lookupTableLookupTableRevisionUpdateParams.lookupTableId
            id = lookupTableLookupTableRevisionUpdateParams.id
            lookupTableRevisionRequest =
                lookupTableLookupTableRevisionUpdateParams.lookupTableRevisionRequest
            additionalHeaders =
                lookupTableLookupTableRevisionUpdateParams.additionalHeaders.toBuilder()
            additionalQueryParams =
                lookupTableLookupTableRevisionUpdateParams.additionalQueryParams.toBuilder()
        }
        ...
        /**
         * Returns an immutable instance of [LookupTableLookupTableRevisionUpdateParams].
         *
         ...
         */
        fun build(): LookupTableLookupTableRevisionUpdateParams =
            LookupTableLookupTableRevisionUpdateParams(
                orgId,
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is LookupTableLookupTableRevisionUpdateParams &&
            orgId == other.orgId &&
    ...
    override fun toString() =
        "LookupTableLookupTableRevisionUpdateParams{orgId=$orgId, lookupTableId=$lookupTableId, id=$id, lookupTableRevisionRequest=$lookupTableRevisionRequest, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
