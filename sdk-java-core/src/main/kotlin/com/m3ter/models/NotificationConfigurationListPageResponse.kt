...
class NotificationConfigurationListPageResponse
private constructor(
    ...
    @JsonProperty("data")
    @ExcludeMissing
    fun _data(): JsonField<List<NotificationConfigurationResponse>> = data
    ...
    companion object {
         ...
         * [NotificationConfigurationListPageResponse].
         */
        @JvmStatic fun builder() = Builder()
    }

    /** A builder for [NotificationConfigurationListPageResponse]. */
    class Builder internal constructor() {

        private var data: JsonField<MutableList<NotificationConfigurationResponse>>? = null
        private var nextToken: JsonField<String> = JsonMissing.of()
        private var additionalProperties: MutableMap<String, JsonValue> = mutableMapOf()

        @JvmSynthetic
        internal fun from(
            notificationConfigurationListPageResponse: NotificationConfigurationListPageResponse
        ) = apply {
            data = notificationConfigurationListPageResponse.data.map { it.toMutableList() }
            nextToken = notificationConfigurationListPageResponse.nextToken
         ...
         * `List<NotificationConfigurationResponse>` value instead. This method is primarily for
        ...
        /**
         * Adds a single [NotificationConfigurationResponse] to [Builder.data].
         *
         * @throws IllegalStateException if the field was previously set to a non-list.
         */
        fun addData(data: NotificationConfigurationResponse) = apply {
            this.data =
        ...
        /**
         * Returns an immutable instance of [NotificationConfigurationListPageResponse].
         *
         * Further updates to this [Builder] will not mutate the returned instance.
         */
        fun build(): NotificationConfigurationListPageResponse =
            NotificationConfigurationListPageResponse(
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return /* spotless:off */ other is NotificationConfigurationListPageResponse && data == other.data && nextToken == other.nextToken && additionalProperties == other.additionalProperties /* spotless:on */
    }
    ...
    override fun toString() =
        "NotificationConfigurationListPageResponse{data=$data, nextToken=$nextToken, additionalProperties=$additionalProperties}"
}
