...
class BalanceChargeScheduleDeleteResponse
...
private constructor(
    ...
    /** A builder for [BalanceChargeScheduleDeleteResponse]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(
            balanceChargeScheduleDeleteResponse: BalanceChargeScheduleDeleteResponse
        ) = apply {
            id = balanceChargeScheduleDeleteResponse.id
            chargeDescription = balanceChargeScheduleDeleteResponse.chargeDescription
            amount = balanceChargeScheduleDeleteResponse.amount
            balanceId = balanceChargeScheduleDeleteResponse.balanceId
            billEpoch = balanceChargeScheduleDeleteResponse.billEpoch
            billFrequency = balanceChargeScheduleDeleteResponse.billFrequency
            billFrequencyInterval = balanceChargeScheduleDeleteResponse.billFrequencyInterval
            billInAdvance = balanceChargeScheduleDeleteResponse.billInAdvance
            code = balanceChargeScheduleDeleteResponse.code
            createdBy = balanceChargeScheduleDeleteResponse.createdBy
            currency = balanceChargeScheduleDeleteResponse.currency
            customFields = balanceChargeScheduleDeleteResponse.customFields
            dtCreated = balanceChargeScheduleDeleteResponse.dtCreated
            dtLastModified = balanceChargeScheduleDeleteResponse.dtLastModified
            lastModifiedBy = balanceChargeScheduleDeleteResponse.lastModifiedBy
            name = balanceChargeScheduleDeleteResponse.name
            nextRun = balanceChargeScheduleDeleteResponse.nextRun
            previousRun = balanceChargeScheduleDeleteResponse.previousRun
            servicePeriodEndDate = balanceChargeScheduleDeleteResponse.servicePeriodEndDate
            servicePeriodStartDate = balanceChargeScheduleDeleteResponse.servicePeriodStartDate
            unitPrice = balanceChargeScheduleDeleteResponse.unitPrice
            units = balanceChargeScheduleDeleteResponse.units
            version = balanceChargeScheduleDeleteResponse.version
            additionalProperties =
                balanceChargeScheduleDeleteResponse.additionalProperties.toMutableMap()
        }
        ...
        /**
         * Returns an immutable instance of [BalanceChargeScheduleDeleteResponse].
         *
         ...
         */
        fun build(): BalanceChargeScheduleDeleteResponse =
            BalanceChargeScheduleDeleteResponse(
                checkRequired("id", id),
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is BalanceChargeScheduleDeleteResponse &&
            id == other.id &&
