...
private constructor(
    private val data: JsonField<List<EventResponse>>,
    ...
    private constructor(
        @JsonProperty("data")
        @ExcludeMissing
        data: JsonField<List<EventResponse>> = JsonMissing.of(),
        @JsonProperty("nextToken") @ExcludeMissing nextToken: JsonField<String> = JsonMissing.of(),
    ) : this(data, nextToken, mutableMapOf())

    /**
     * The list of Event information.
     *
     * @throws M3terInvalidDataException if the JSON field has an unexpected type (e.g. if the
     *   server responded with an unexpected value).
     */
    fun data(): Optional<List<EventResponse>> = data.getOptional("data")
     ...
     */
    @JsonProperty("data") @ExcludeMissing fun _data(): JsonField<List<EventResponse>> = data
    ...
    class Builder internal constructor() {
        ...
        private var data: JsonField<MutableList<EventResponse>>? = null
        ...
        internal fun from(eventListPageResponse: EventListPageResponse) = apply {
            ...
            nextToken = eventListPageResponse.nextToken
         ...
         *
         * You should usually call [Builder.data] with a well-typed `List<EventResponse>` value
         * instead. This method is primarily for setting the field to an undocumented or not yet
         * supported value.
         */
        fun data(data: JsonField<List<EventResponse>>) = apply {
            this.data = data.map { it.toMutableList() }
        }

        /**
         * Adds a single [EventResponse] to [Builder.data].
         *
         * @throws IllegalStateException if the field was previously set to a non-list.
         */
        fun addData(data: EventResponse) = apply {
            this.data =
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return /* spotless:off */ other is EventListPageResponse && data == other.data && nextToken == other.nextToken && additionalProperties == other.additionalProperties /* spotless:on */
    }
    ...
    override fun toString() =
        "EventListPageResponse{data=$data, nextToken=$nextToken, additionalProperties=$additionalProperties}"
}
