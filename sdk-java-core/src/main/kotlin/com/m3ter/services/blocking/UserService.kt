...
interface UserService {
     ...
     *   a member. You can use the `inherited` parameter with this *Retrieve OrgUser Groups* call as
     *   a *QUERY PARAMETER* to control which User Resource Groups are returned:
