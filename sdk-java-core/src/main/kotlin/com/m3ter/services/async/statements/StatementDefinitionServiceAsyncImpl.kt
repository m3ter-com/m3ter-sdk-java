...
internal constructor(private val clientOptions: ClientOptions) : StatementDefinitionServiceAsync {

    private val withRawResponse: StatementDefinitionServiceAsync.WithRawResponse by lazy {
                ...
                .thenApply { response ->
                    response.parseable {
                        response
                            ...
                            .let {
                                StatementStatementDefinitionListPageAsync.builder()
                                    .service(StatementDefinitionServiceAsyncImpl(clientOptions))
