...
-keep @com.fasterxml.jackson.databind.annotation.JsonSerialize class com.m3ter.** { *; }
-keep @com.fasterxml.jackson.databind.annotation.JsonDeserialize class com.m3ter.** { *; }

# Jackson uses reflection to serialize and deserialize our classes based on their constructors and annotated members.
-keepclassmembers class com.m3ter.** {
    <init>(...);
