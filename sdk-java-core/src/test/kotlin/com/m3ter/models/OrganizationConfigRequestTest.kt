...
internal class OrganizationConfigRequestTest {
    ...
    fun create() {
        ...
        assertThat(organizationConfigRequest.daysBeforeBillDue()).isEqualTo(1L)
        ...
        assertThat(organizationConfigRequest.autoApproveBillsGracePeriod()).contains(2L)
        ...
        assertThat(organizationConfigRequest.sequenceStartNumber()).contains(1000L)
