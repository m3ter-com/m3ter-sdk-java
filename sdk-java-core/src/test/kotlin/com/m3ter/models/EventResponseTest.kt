...
internal class EventResponseTest {
    ...
    fun roundtrip() {
        ...
        val roundtrippedEventResponse =
            jsonMapper.readValue(
                jsonMapper.writeValueAsString(eventResponse),
                jacksonTypeRef<EventResponse>(),
            )

        assertThat(roundtrippedEventResponse).isEqualTo(eventResponse)
    }
}
