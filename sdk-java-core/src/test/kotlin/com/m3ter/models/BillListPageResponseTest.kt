...
internal class BillListPageResponseTest {

    @Test
    fun create() {
        val billListPageResponse =
            BillListPageResponse.builder()
                .addData(
        ...
        assertThat(billListPageResponse.data().getOrNull())
            .containsExactly(
                BillResponse.builder()
                    .id("id")
                    .accountCode("accountCode")
    ...
    fun roundtrip() {
        ...
        val roundtrippedBillListPageResponse =
            jsonMapper.readValue(
                jsonMapper.writeValueAsString(billListPageResponse),
                jacksonTypeRef<BillListPageResponse>(),
            )

        assertThat(roundtrippedBillListPageResponse).isEqualTo(billListPageResponse)
    }
}
