...
internal class ChargeScheduleServiceTest {
    ...
    fun create() {
        val client =
            M3terOkHttpClient.builder()
                ...
                .orgId("My Org ID")
                .build()
        val chargeScheduleService = client.balances().chargeSchedules()

        val chargeSchedule =
            chargeScheduleService.create(
    ...
    fun retrieve() {
        ...
        val chargeSchedule =
            chargeScheduleService.retrieve(
    ...
    fun list() {
        ...
        val page = chargeScheduleService.list("balanceId")
