...
/**
 * A class that allows building an instance of [M3terClientAsync] with [OkHttpClient] as the
...
class M3terOkHttpClientAsync private constructor() {
    ...
    companion object {
        ...
        /** Returns a mutable builder for constructing an instance of [M3terClientAsync]. */
