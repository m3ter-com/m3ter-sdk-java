...
[![Maven Central](https://img.shields.io/maven-central/v/com.m3ter/sdk-java)](https://central.sonatype.com/artifact/com.m3ter/sdk-java/0.3.1-alpha)
[![javadoc](https://javadoc.io/badge2/com.m3ter/sdk-java/0.3.1-alpha/javadoc.svg)](https://javadoc.io/doc/com.m3ter/sdk-java/0.3.1-alpha)
...
The REST API documentation can be found on [www.m3ter.com](https://www.m3ter.com). Javadocs are available on [javadoc.io](https://javadoc.io/doc/com.m3ter/sdk-java/0.3.1-alpha).
...
```kotlin
implementation("com.m3ter:sdk-java:0.3.1-alpha")
```
