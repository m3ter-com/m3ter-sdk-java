...
private constructor(
    ...
    @JvmSynthetic internal fun getBody(): CompoundAggregationCreateBody = body
    ...
    /** A builder for [CompoundAggregationCreateParams]. */
    @NoAutoDetect
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(compoundAggregationCreateParams: CompoundAggregationCreateParams) =
            apply {
                orgId = compoundAggregationCreateParams.orgId
                body = compoundAggregationCreateParams.body.toBuilder()
                additionalHeaders = compoundAggregationCreateParams.additionalHeaders.toBuilder()
                additionalQueryParams =
                    compoundAggregationCreateParams.additionalQueryParams.toBuilder()
            }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return /* spotless:off */ other is CompoundAggregationCreateParams && orgId == other.orgId && body == other.body && additionalHeaders == other.additionalHeaders && additionalQueryParams == other.additionalQueryParams /* spotless:on */
    }

    override fun hashCode(): Int = /* spotless:off */ Objects.hash(orgId, body, additionalHeaders, additionalQueryParams) /* spotless:on */

    override fun toString() =
        "CompoundAggregationCreateParams{orgId=$orgId, body=$body, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
