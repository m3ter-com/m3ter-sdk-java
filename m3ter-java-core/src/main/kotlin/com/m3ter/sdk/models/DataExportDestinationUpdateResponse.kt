...
private constructor(
    ...
    /** A builder for [DataExportDestinationUpdateResponse]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(
            dataExportDestinationUpdateResponse: DataExportDestinationUpdateResponse
        ) = apply {
            id = dataExportDestinationUpdateResponse.id
            version = dataExportDestinationUpdateResponse.version
            code = dataExportDestinationUpdateResponse.code
            createdBy = dataExportDestinationUpdateResponse.createdBy
            dtCreated = dataExportDestinationUpdateResponse.dtCreated
            dtLastModified = dataExportDestinationUpdateResponse.dtLastModified
            lastModifiedBy = dataExportDestinationUpdateResponse.lastModifiedBy
            name = dataExportDestinationUpdateResponse.name
            bucketName = dataExportDestinationUpdateResponse.bucketName
            iamRoleArn = dataExportDestinationUpdateResponse.iamRoleArn
            partitionOrder = dataExportDestinationUpdateResponse.partitionOrder
            prefix = dataExportDestinationUpdateResponse.prefix
            additionalProperties =
                dataExportDestinationUpdateResponse.additionalProperties.toMutableMap()
        }
        ...
        /**
         * Returns an immutable instance of [DataExportDestinationUpdateResponse].
         *
         ...
         */
        fun build(): DataExportDestinationUpdateResponse =
            DataExportDestinationUpdateResponse(
                checkRequired("id", id),
