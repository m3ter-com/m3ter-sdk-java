...
private constructor(
    ...
    fun validate(): FileUploadJob = apply {
        if (validated) {
            return@apply
        }
    ...
    companion object {
        ...
        /** Returns a mutable builder for constructing an instance of [FileUploadJob]. */
        @JvmStatic fun builder() = Builder()
    }

    /** A builder for [FileUploadJob]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(fileUploadJob: FileUploadJob) = apply {
            id = fileUploadJob.id
            contentLength = fileUploadJob.contentLength
            failedRows = fileUploadJob.failedRows
            fileName = fileUploadJob.fileName
            processedRows = fileUploadJob.processedRows
            status = fileUploadJob.status
            totalRows = fileUploadJob.totalRows
            uploadDate = fileUploadJob.uploadDate
            version = fileUploadJob.version
            additionalProperties = fileUploadJob.additionalProperties.toMutableMap()
        }
    ...
    override fun toString() =
        "FileUploadJob{id=$id, contentLength=$contentLength, failedRows=$failedRows, fileName=$fileName, processedRows=$processedRows, status=$status, totalRows=$totalRows, uploadDate=$uploadDate, version=$version, additionalProperties=$additionalProperties}"
}
