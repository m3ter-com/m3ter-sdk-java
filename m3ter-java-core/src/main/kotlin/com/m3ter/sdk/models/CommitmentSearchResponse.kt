...
private constructor(
    ...
    class Builder internal constructor() {
        ...
        fun build(): CommitmentSearchResponse =
            CommitmentSearchResponse(additionalProperties.toImmutable())
    }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return /* spotless:off */ other is CommitmentSearchResponse && additionalProperties == other.additionalProperties /* spotless:on */
    }
    ...
    override fun toString() = "CommitmentSearchResponse{additionalProperties=$additionalProperties}"
}
