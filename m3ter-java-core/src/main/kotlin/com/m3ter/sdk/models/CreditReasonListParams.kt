...
private constructor(
    ...
    /** A builder for [CreditReasonListParams]. */
    @NoAutoDetect
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(creditReasonListParams: CreditReasonListParams) = apply {
            orgId = creditReasonListParams.orgId
            archived = creditReasonListParams.archived
            codes = creditReasonListParams.codes?.toMutableList()
            ids = creditReasonListParams.ids?.toMutableList()
            nextToken = creditReasonListParams.nextToken
            pageSize = creditReasonListParams.pageSize
            additionalHeaders = creditReasonListParams.additionalHeaders.toBuilder()
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return /* spotless:off */ other is CreditReasonListParams && orgId == other.orgId && archived == other.archived && codes == other.codes && ids == other.ids && nextToken == other.nextToken && pageSize == other.pageSize && additionalHeaders == other.additionalHeaders && additionalQueryParams == other.additionalQueryParams /* spotless:on */
    }
    ...
    override fun toString() =
        "CreditReasonListParams{orgId=$orgId, archived=$archived, codes=$codes, ids=$ids, nextToken=$nextToken, pageSize=$pageSize, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
