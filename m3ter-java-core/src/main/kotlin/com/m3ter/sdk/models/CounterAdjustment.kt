...
private constructor(
    ...
    fun validate(): CounterAdjustment = apply {
        if (validated) {
            return@apply
        }
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [CounterAdjustment].
         *
    ...
    /** A builder for [CounterAdjustment]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(counterAdjustment: CounterAdjustment) = apply {
            id = counterAdjustment.id
            version = counterAdjustment.version
            accountId = counterAdjustment.accountId
            counterId = counterAdjustment.counterId
            createdBy = counterAdjustment.createdBy
            date = counterAdjustment.date
            dtCreated = counterAdjustment.dtCreated
            dtLastModified = counterAdjustment.dtLastModified
            lastModifiedBy = counterAdjustment.lastModifiedBy
            purchaseOrderNumber = counterAdjustment.purchaseOrderNumber
            value = counterAdjustment.value
            additionalProperties = counterAdjustment.additionalProperties.toMutableMap()
        }
    ...
    override fun toString() =
        "CounterAdjustment{id=$id, version=$version, accountId=$accountId, counterId=$counterId, createdBy=$createdBy, date=$date, dtCreated=$dtCreated, dtLastModified=$dtLastModified, lastModifiedBy=$lastModifiedBy, purchaseOrderNumber=$purchaseOrderNumber, value=$value, additionalProperties=$additionalProperties}"
}
