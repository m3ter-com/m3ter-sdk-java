...
class PermissionPolicyRemoveFromUserGroupResponse
private constructor(
    ...
    /** A builder for [PermissionPolicyRemoveFromUserGroupResponse]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(
            permissionPolicyRemoveFromUserGroupResponse: PermissionPolicyRemoveFromUserGroupResponse
        ) = apply {
            id = permissionPolicyRemoveFromUserGroupResponse.id
            createdBy = permissionPolicyRemoveFromUserGroupResponse.createdBy
            dtCreated = permissionPolicyRemoveFromUserGroupResponse.dtCreated
            dtLastModified = permissionPolicyRemoveFromUserGroupResponse.dtLastModified
            lastModifiedBy = permissionPolicyRemoveFromUserGroupResponse.lastModifiedBy
            permissionPolicyId = permissionPolicyRemoveFromUserGroupResponse.permissionPolicyId
            principalId = permissionPolicyRemoveFromUserGroupResponse.principalId
            principalType = permissionPolicyRemoveFromUserGroupResponse.principalType
            version = permissionPolicyRemoveFromUserGroupResponse.version
            additionalProperties =
                permissionPolicyRemoveFromUserGroupResponse.additionalProperties.toMutableMap()
        }
        ...
        /**
         * Returns an immutable instance of [PermissionPolicyRemoveFromUserGroupResponse].
         *
         * Further updates to this [Builder] will not mutate the returned instance.
         */
        fun build(): PermissionPolicyRemoveFromUserGroupResponse =
            PermissionPolicyRemoveFromUserGroupResponse(
                id,
                createdBy,
                dtCreated,
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return /* spotless:off */ other is PermissionPolicyRemoveFromUserGroupResponse && id == other.id && createdBy == other.createdBy && dtCreated == other.dtCreated && dtLastModified == other.dtLastModified && lastModifiedBy == other.lastModifiedBy && permissionPolicyId == other.permissionPolicyId && principalId == other.principalId && principalType == other.principalType && version == other.version && additionalProperties == other.additionalProperties /* spotless:on */
    }
    ...
    override fun toString() =
        "PermissionPolicyRemoveFromUserGroupResponse{id=$id, createdBy=$createdBy, dtCreated=$dtCreated, dtLastModified=$dtLastModified, lastModifiedBy=$lastModifiedBy, permissionPolicyId=$permissionPolicyId, principalId=$principalId, principalType=$principalType, version=$version, additionalProperties=$additionalProperties}"
}
