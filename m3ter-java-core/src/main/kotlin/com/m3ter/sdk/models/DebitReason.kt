...
private constructor(
    ...
    fun validate(): DebitReason = apply {
        if (validated) {
            return@apply
        }
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [DebitReason].
         *
    ...
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(debitReason: DebitReason) = apply {
            id = debitReason.id
            version = debitReason.version
            archived = debitReason.archived
            code = debitReason.code
            createdBy = debitReason.createdBy
            dtCreated = debitReason.dtCreated
            dtLastModified = debitReason.dtLastModified
            lastModifiedBy = debitReason.lastModifiedBy
            name = debitReason.name
            additionalProperties = debitReason.additionalProperties.toMutableMap()
        }
    ...
    override fun toString() =
        "DebitReason{id=$id, version=$version, archived=$archived, code=$code, createdBy=$createdBy, dtCreated=$dtCreated, dtLastModified=$dtLastModified, lastModifiedBy=$lastModifiedBy, name=$name, additionalProperties=$additionalProperties}"
}
