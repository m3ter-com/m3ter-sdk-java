...
private constructor(
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [CreditReasonResponse].
         *
    ...
    /** A builder for [CreditReasonResponse]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(creditReasonResponse: CreditReasonResponse) = apply {
            id = creditReasonResponse.id
            version = creditReasonResponse.version
            archived = creditReasonResponse.archived
            code = creditReasonResponse.code
            createdBy = creditReasonResponse.createdBy
            dtCreated = creditReasonResponse.dtCreated
            dtLastModified = creditReasonResponse.dtLastModified
            lastModifiedBy = creditReasonResponse.lastModifiedBy
            name = creditReasonResponse.name
            additionalProperties = creditReasonResponse.additionalProperties.toMutableMap()
        }
        ...
        /**
         * Returns an immutable instance of [CreditReasonResponse].
         *
         ...
         */
        fun build(): CreditReasonResponse =
    ...
    override fun toString() =
        "CreditReasonResponse{id=$id, version=$version, archived=$archived, code=$code, createdBy=$createdBy, dtCreated=$dtCreated, dtLastModified=$dtLastModified, lastModifiedBy=$lastModifiedBy, name=$name, additionalProperties=$additionalProperties}"
}
