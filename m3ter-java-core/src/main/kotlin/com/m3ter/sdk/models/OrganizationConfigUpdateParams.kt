...
private constructor(
     ...
     *
     * **NOTE:** You can override this Organization-level setting for credit application order at
    ...
    internal constructor(
        ...
        @ExcludeMissing
        private val dayEpoch: JsonField<String> = JsonMissing.of(),
        @JsonProperty("daysBeforeBillDue")
        @ExcludeMissing
        private val daysBeforeBillDue: JsonField<Long> = JsonMissing.of(),
        @JsonProperty("monthEpoch")
        @ExcludeMissing
        private val monthEpoch: JsonField<String> = JsonMissing.of(),
        @JsonProperty("timezone")
        @ExcludeMissing
        private val timezone: JsonField<String> = JsonMissing.of(),
        @JsonProperty("weekEpoch")
        @ExcludeMissing
        private val weekEpoch: JsonField<String> = JsonMissing.of(),
        @JsonProperty("yearEpoch")
        @ExcludeMissing
        private val yearEpoch: JsonField<String> = JsonMissing.of(),
        ...
        @ExcludeMissing
        private val autoApproveBillsGracePeriodUnit: JsonField<String> = JsonMissing.of(),
        ...
        @ExcludeMissing
        private val externalInvoiceDate: JsonField<String> = JsonMissing.of(),
        ...
        fun autoApproveBillsGracePeriod(): Optional<Long> =
            Optional.ofNullable(
                autoApproveBillsGracePeriod.getNullable("autoApproveBillsGracePeriod")
            )
         ...
         * - `"BALANCE"`. Only draw-down against Balance credit.
         *
         * **NOTE:** You can override this Organization-level setting for credit application order
        ...
        class Builder internal constructor() {
             ...
             * - `"BALANCE"`. Only draw-down against Balance credit.
             *
             * **NOTE:** You can override this Organization-level setting for credit application
             * order at the level of an individual Account.
             */
