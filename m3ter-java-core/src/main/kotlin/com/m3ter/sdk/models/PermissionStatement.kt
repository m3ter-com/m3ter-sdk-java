...
private constructor(
    ...
    fun validate(): PermissionStatement = apply {
        if (validated) {
            return@apply
        }
    ...
    /** A builder for [PermissionStatement]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(permissionStatement: PermissionStatement) = apply {
            action = permissionStatement.action.map { it.toMutableList() }
            effect = permissionStatement.effect
            resource = permissionStatement.resource.map { it.toMutableList() }
            additionalProperties = permissionStatement.additionalProperties.toMutableMap()
        }
        ...
        fun addAction(action: Action) = apply {
            this.action =
                (this.action ?: JsonField.of(mutableListOf())).apply {
                    asKnown()
                        .orElseThrow {
        ...
        fun addResource(resource: String) = apply {
            this.resource =
                (this.resource ?: JsonField.of(mutableListOf())).apply {
                    asKnown()
                        .orElseThrow {
                            IllegalStateException(
                                "Field was set to non-list type: ${javaClass.simpleName}"
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return /* spotless:off */ other is PermissionStatement && action == other.action && effect == other.effect && resource == other.resource && additionalProperties == other.additionalProperties /* spotless:on */
    }
    ...
    override fun toString() =
        "PermissionStatement{action=$action, effect=$effect, resource=$resource, additionalProperties=$additionalProperties}"
}
