...
private constructor(
    ...
    class AutoPager(private val firstPage: CreditReasonListPage) : Iterable<CreditReason> {

        override fun iterator(): Iterator<CreditReason> = iterator {
            var page = firstPage
            var index = 0
            while (true) {
        ...
        fun stream(): Stream<CreditReason> {
