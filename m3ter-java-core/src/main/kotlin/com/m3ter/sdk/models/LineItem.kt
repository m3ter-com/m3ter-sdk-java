...
private constructor(
    ...
    class Builder internal constructor() {
        ...
        internal fun from(lineItem: LineItem) = apply {
            ...
            bandUsage = lineItem.bandUsage.map { it.toMutableList() }
            ...
            dtCreated = lineItem.dtCreated
            dtLastModified = lineItem.dtLastModified
            group = lineItem.group
            jsonUsageGenerated = lineItem.jsonUsageGenerated
            lastModifiedBy = lineItem.lastModifiedBy
        ...
        fun addBandUsage(bandUsage: BandUsage) = apply {
            this.bandUsage =
                (this.bandUsage ?: JsonField.of(mutableListOf())).apply {
                    asKnown()
                        .orElseThrow {
