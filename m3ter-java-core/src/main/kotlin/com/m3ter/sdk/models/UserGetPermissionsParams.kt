...
private constructor(
    ...
    /** A builder for [UserGetPermissionsParams]. */
    @NoAutoDetect
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(userGetPermissionsParams: UserGetPermissionsParams) = apply {
            orgId = userGetPermissionsParams.orgId
            id = userGetPermissionsParams.id
            nextToken = userGetPermissionsParams.nextToken
            pageSize = userGetPermissionsParams.pageSize
            additionalHeaders = userGetPermissionsParams.additionalHeaders.toBuilder()
            additionalQueryParams = userGetPermissionsParams.additionalQueryParams.toBuilder()
        }
