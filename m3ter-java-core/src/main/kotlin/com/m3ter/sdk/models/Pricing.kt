...
private constructor(
    ...
    class Builder internal constructor() {
        ...
        internal fun from(pricing: Pricing) = apply {
            ...
            code = pricing.code
            compoundAggregationId = pricing.compoundAggregationId
            createdBy = pricing.createdBy
            cumulative = pricing.cumulative
            description = pricing.description
            dtCreated = pricing.dtCreated
            dtLastModified = pricing.dtLastModified
            endDate = pricing.endDate
            lastModifiedBy = pricing.lastModifiedBy
            minimumSpend = pricing.minimumSpend
            minimumSpendBillInAdvance = pricing.minimumSpendBillInAdvance
            minimumSpendDescription = pricing.minimumSpendDescription
            overagePricingBands = pricing.overagePricingBands.map { it.toMutableList() }
            planId = pricing.planId
            planTemplateId = pricing.planTemplateId
            pricingBands = pricing.pricingBands.map { it.toMutableList() }
            segment = pricing.segment
            segmentString = pricing.segmentString
            startDate = pricing.startDate
            tiersSpanPlan = pricing.tiersSpanPlan
            type = pricing.type
