...
private constructor(
    ...
    /** A builder for [BillUpdateStatusParams]. */
    @NoAutoDetect
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(billUpdateStatusParams: BillUpdateStatusParams) = apply {
            orgId = billUpdateStatusParams.orgId
            id = billUpdateStatusParams.id
            body = billUpdateStatusParams.body.toBuilder()
            additionalHeaders = billUpdateStatusParams.additionalHeaders.toBuilder()
            additionalQueryParams = billUpdateStatusParams.additionalQueryParams.toBuilder()
        }
        ...
        /**
         * Returns an immutable instance of [BillUpdateStatusParams].
         *
         * Further updates to this [Builder] will not mutate the returned instance.
         *
         * The following fields are required:
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return /* spotless:off */ other is BillUpdateStatusParams && orgId == other.orgId && id == other.id && body == other.body && additionalHeaders == other.additionalHeaders && additionalQueryParams == other.additionalQueryParams /* spotless:on */
    }
    ...
    override fun toString() =
        "BillUpdateStatusParams{orgId=$orgId, id=$id, body=$body, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
