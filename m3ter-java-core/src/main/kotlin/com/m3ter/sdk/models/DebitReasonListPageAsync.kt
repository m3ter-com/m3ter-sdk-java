...
private constructor(
    ...
    fun data(): List<DebitReason> = response().data()
    ...
    @JsonCreator
    constructor(
        @JsonProperty("data") private val data: JsonField<List<DebitReason>> = JsonMissing.of(),
        @JsonProperty("nextToken") private val nextToken: JsonField<String> = JsonMissing.of(),
        @JsonAnySetter
        private val additionalProperties: Map<String, JsonValue> = immutableEmptyMap(),
    ) {

        fun data(): List<DebitReason> = data.getNullable("data") ?: listOf()

        fun nextToken(): Optional<String> = Optional.ofNullable(nextToken.getNullable("nextToken"))

        @JsonProperty("data")
        fun _data(): Optional<JsonField<List<DebitReason>>> = Optional.ofNullable(data)
        ...
        class Builder {
            ...
            private var data: JsonField<List<DebitReason>> = JsonMissing.of()
            ...
            fun data(data: List<DebitReason>) = data(JsonField.of(data))

            fun data(data: JsonField<List<DebitReason>>) = apply { this.data = data }
    ...
    class AutoPager(
        private val firstPage: DebitReasonListPageAsync,
    ) {

        fun forEach(action: Predicate<DebitReason>, executor: Executor): CompletableFuture<Void> {
            fun CompletableFuture<Optional<DebitReasonListPageAsync>>.forEach(
                action: (DebitReason) -> Boolean,
                executor: Executor
        ...
        fun toList(executor: Executor): CompletableFuture<List<DebitReason>> {
            val values = mutableListOf<DebitReason>()
