...
private constructor(
    ...
    class AutoPager(private val firstPage: BillCreditLineItemListPageAsync) {
        ...
        fun toList(executor: Executor): CompletableFuture<List<CreditLineItem>> {
            val values = mutableListOf<CreditLineItem>()
