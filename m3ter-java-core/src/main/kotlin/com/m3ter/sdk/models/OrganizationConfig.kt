...
private constructor(
    ...
    class Builder internal constructor() {
        ...
        internal fun from(organizationConfig: OrganizationConfig) = apply {
            ...
            version = organizationConfig.version
            autoApproveBillsGracePeriod = organizationConfig.autoApproveBillsGracePeriod
            autoApproveBillsGracePeriodUnit = organizationConfig.autoApproveBillsGracePeriodUnit
            autoGenerateStatementMode = organizationConfig.autoGenerateStatementMode
            billPrefix = organizationConfig.billPrefix
            commitmentFeeBillInAdvance = organizationConfig.commitmentFeeBillInAdvance
            consolidateBills = organizationConfig.consolidateBills
            createdBy = organizationConfig.createdBy
            creditApplicationOrder =
                organizationConfig.creditApplicationOrder.map { it.toMutableList() }
            currency = organizationConfig.currency
            currencyConversions = organizationConfig.currencyConversions.map { it.toMutableList() }
            dayEpoch = organizationConfig.dayEpoch
            daysBeforeBillDue = organizationConfig.daysBeforeBillDue
            defaultStatementDefinitionId = organizationConfig.defaultStatementDefinitionId
            dtCreated = organizationConfig.dtCreated
            dtLastModified = organizationConfig.dtLastModified
            externalInvoiceDate = organizationConfig.externalInvoiceDate
            lastModifiedBy = organizationConfig.lastModifiedBy
            minimumSpendBillInAdvance = organizationConfig.minimumSpendBillInAdvance
            monthEpoch = organizationConfig.monthEpoch
            scheduledBillInterval = organizationConfig.scheduledBillInterval
            sequenceStartNumber = organizationConfig.sequenceStartNumber
            standingChargeBillInAdvance = organizationConfig.standingChargeBillInAdvance
            suppressedEmptyBills = organizationConfig.suppressedEmptyBills
            timezone = organizationConfig.timezone
            weekEpoch = organizationConfig.weekEpoch
            yearEpoch = organizationConfig.yearEpoch
