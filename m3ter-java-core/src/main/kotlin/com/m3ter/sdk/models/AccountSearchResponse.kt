...
private constructor(
    ...
    class Builder internal constructor() {
        ...
        fun build(): AccountSearchResponse =
            AccountSearchResponse(additionalProperties.toImmutable())
    }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return /* spotless:off */ other is AccountSearchResponse && additionalProperties == other.additionalProperties /* spotless:on */
    }
    ...
    override fun toString() = "AccountSearchResponse{additionalProperties=$additionalProperties}"
}
