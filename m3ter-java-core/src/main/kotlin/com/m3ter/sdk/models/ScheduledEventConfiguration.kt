...
private constructor(
    ...
    fun validate(): ScheduledEventConfiguration = apply {
        if (validated) {
            return@apply
        }
    ...
    /** A builder for [ScheduledEventConfiguration]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(scheduledEventConfiguration: ScheduledEventConfiguration) = apply {
            id = scheduledEventConfiguration.id
            entity = scheduledEventConfiguration.entity
            field = scheduledEventConfiguration.field
            name = scheduledEventConfiguration.name
            offset = scheduledEventConfiguration.offset
            version = scheduledEventConfiguration.version
            createdBy = scheduledEventConfiguration.createdBy
            dtCreated = scheduledEventConfiguration.dtCreated
            dtLastModified = scheduledEventConfiguration.dtLastModified
            lastModifiedBy = scheduledEventConfiguration.lastModifiedBy
            additionalProperties = scheduledEventConfiguration.additionalProperties.toMutableMap()
        }
        ...
        fun build(): ScheduledEventConfiguration =
    ...
    override fun toString() =
        "ScheduledEventConfiguration{id=$id, entity=$entity, field=$field, name=$name, offset=$offset, version=$version, createdBy=$createdBy, dtCreated=$dtCreated, dtLastModified=$dtLastModified, lastModifiedBy=$lastModifiedBy, additionalProperties=$additionalProperties}"
}
