 ...
 */
class TransactionTypeUpdateParams
private constructor(
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [TransactionTypeUpdateParams].
         *
    ...
    /** A builder for [TransactionTypeUpdateParams]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(transactionTypeUpdateParams: TransactionTypeUpdateParams) = apply {
            orgId = transactionTypeUpdateParams.orgId
            id = transactionTypeUpdateParams.id
            body = transactionTypeUpdateParams.body.toBuilder()
            additionalHeaders = transactionTypeUpdateParams.additionalHeaders.toBuilder()
            additionalQueryParams = transactionTypeUpdateParams.additionalQueryParams.toBuilder()
        }
        ...
        /**
         * Returns an immutable instance of [TransactionTypeUpdateParams].
         *
         ...
         */
        fun build(): TransactionTypeUpdateParams =
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return /* spotless:off */ other is TransactionTypeUpdateParams && orgId == other.orgId && id == other.id && body == other.body && additionalHeaders == other.additionalHeaders && additionalQueryParams == other.additionalQueryParams /* spotless:on */
    }

    override fun hashCode(): Int = /* spotless:off */ Objects.hash(orgId, id, body, additionalHeaders, additionalQueryParams) /* spotless:on */

    override fun toString() =
        "TransactionTypeUpdateParams{orgId=$orgId, id=$id, body=$body, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
