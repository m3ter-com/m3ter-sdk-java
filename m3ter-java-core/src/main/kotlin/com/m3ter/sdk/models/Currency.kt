...
private constructor(
    ...
    class Builder internal constructor() {
        ...
        internal fun from(currency: Currency) = apply {
            ...
            dtCreated = currency.dtCreated
            dtLastModified = currency.dtLastModified
            lastModifiedBy = currency.lastModifiedBy
            maxDecimalPlaces = currency.maxDecimalPlaces
            name = currency.name
    ...
    override fun toString() =
        "Currency{id=$id, version=$version, archived=$archived, code=$code, createdBy=$createdBy, dtCreated=$dtCreated, dtLastModified=$dtLastModified, lastModifiedBy=$lastModifiedBy, maxDecimalPlaces=$maxDecimalPlaces, name=$name, roundingMode=$roundingMode, additionalProperties=$additionalProperties}"
}
