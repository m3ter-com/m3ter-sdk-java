...
private constructor(
    ...
    internal constructor(
        ...
        class Builder internal constructor() {
            ...
            internal fun from(contractCreateBody: ContractCreateBody) = apply {
                accountId = contractCreateBody.accountId
                endDate = contractCreateBody.endDate
                name = contractCreateBody.name
                startDate = contractCreateBody.startDate
                code = contractCreateBody.code
                customFields = contractCreateBody.customFields
                description = contractCreateBody.description
                purchaseOrderNumber = contractCreateBody.purchaseOrderNumber
                version = contractCreateBody.version
        ...
        override fun equals(other: Any?): Boolean {
            ...
            return /* spotless:off */ other is ContractCreateBody && accountId == other.accountId && endDate == other.endDate && name == other.name && startDate == other.startDate && code == other.code && customFields == other.customFields && description == other.description && purchaseOrderNumber == other.purchaseOrderNumber && version == other.version && additionalProperties == other.additionalProperties /* spotless:on */
        }
        ...
        override fun toString() =
            "ContractCreateBody{accountId=$accountId, endDate=$endDate, name=$name, startDate=$startDate, code=$code, customFields=$customFields, description=$description, purchaseOrderNumber=$purchaseOrderNumber, version=$version, additionalProperties=$additionalProperties}"
    }
    ...
    /** A builder for [ContractCreateParams]. */
    @NoAutoDetect
    class Builder internal constructor() {
        ...
        internal fun from(contractCreateParams: ContractCreateParams) = apply {
            orgId = contractCreateParams.orgId
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return /* spotless:off */ other is ContractCreateParams && orgId == other.orgId && body == other.body && additionalHeaders == other.additionalHeaders && additionalQueryParams == other.additionalQueryParams /* spotless:on */
    }

    override fun hashCode(): Int = /* spotless:off */ Objects.hash(orgId, body, additionalHeaders, additionalQueryParams) /* spotless:on */

    override fun toString() =
        "ContractCreateParams{orgId=$orgId, body=$body, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
