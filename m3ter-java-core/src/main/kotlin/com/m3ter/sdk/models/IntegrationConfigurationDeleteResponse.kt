...
private constructor(
    ...
    /** A builder for [IntegrationConfigurationDeleteResponse]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(
            integrationConfigurationDeleteResponse: IntegrationConfigurationDeleteResponse
        ) = apply {
            id = integrationConfigurationDeleteResponse.id
            destination = integrationConfigurationDeleteResponse.destination
            entityType = integrationConfigurationDeleteResponse.entityType
            version = integrationConfigurationDeleteResponse.version
            authorized = integrationConfigurationDeleteResponse.authorized
            configData = integrationConfigurationDeleteResponse.configData
            createdBy = integrationConfigurationDeleteResponse.createdBy
            destinationId = integrationConfigurationDeleteResponse.destinationId
            dtCreated = integrationConfigurationDeleteResponse.dtCreated
            dtLastModified = integrationConfigurationDeleteResponse.dtLastModified
            enabled = integrationConfigurationDeleteResponse.enabled
            entityId = integrationConfigurationDeleteResponse.entityId
            integrationCredentialsId =
                integrationConfigurationDeleteResponse.integrationCredentialsId
            lastModifiedBy = integrationConfigurationDeleteResponse.lastModifiedBy
            name = integrationConfigurationDeleteResponse.name
            triggerType = integrationConfigurationDeleteResponse.triggerType
            additionalProperties =
                integrationConfigurationDeleteResponse.additionalProperties.toMutableMap()
        }
