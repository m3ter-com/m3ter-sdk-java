...
private constructor(
    ...
    /** A builder for [DataExportScheduleListParams]. */
    @NoAutoDetect
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(dataExportScheduleListParams: DataExportScheduleListParams) = apply {
            orgId = dataExportScheduleListParams.orgId
            ids = dataExportScheduleListParams.ids?.toMutableList()
            nextToken = dataExportScheduleListParams.nextToken
            pageSize = dataExportScheduleListParams.pageSize
            additionalHeaders = dataExportScheduleListParams.additionalHeaders.toBuilder()
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return /* spotless:off */ other is DataExportScheduleListParams && orgId == other.orgId && ids == other.ids && nextToken == other.nextToken && pageSize == other.pageSize && additionalHeaders == other.additionalHeaders && additionalQueryParams == other.additionalQueryParams /* spotless:on */
    }
    ...
    override fun toString() =
        "DataExportScheduleListParams{orgId=$orgId, ids=$ids, nextToken=$nextToken, pageSize=$pageSize, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
