...
private constructor(
    ...
    private val body: BalanceUpdateBody,
    ...
    @JvmSynthetic internal fun _body(): BalanceUpdateBody = body
    ...
    internal constructor(
        ...
        fun validate(): BalanceUpdateBody = apply {
            if (validated) {
                return@apply
            }
        ...
        /** A builder for [BalanceUpdateBody]. */
        class Builder internal constructor() {
            ...
            @JvmSynthetic
            internal fun from(balanceUpdateBody: BalanceUpdateBody) = apply {
                accountId = balanceUpdateBody.accountId
                currency = balanceUpdateBody.currency
                endDate = balanceUpdateBody.endDate
                startDate = balanceUpdateBody.startDate
                balanceDrawDownDescription = balanceUpdateBody.balanceDrawDownDescription
                code = balanceUpdateBody.code
                consumptionsAccountingProductId = balanceUpdateBody.consumptionsAccountingProductId
                description = balanceUpdateBody.description
                feesAccountingProductId = balanceUpdateBody.feesAccountingProductId
                lineItemTypes = balanceUpdateBody.lineItemTypes.map { it.toMutableList() }
                name = balanceUpdateBody.name
                overageDescription = balanceUpdateBody.overageDescription
                overageSurchargePercent = balanceUpdateBody.overageSurchargePercent
                productIds = balanceUpdateBody.productIds.map { it.toMutableList() }
                rolloverAmount = balanceUpdateBody.rolloverAmount
                rolloverEndDate = balanceUpdateBody.rolloverEndDate
                version = balanceUpdateBody.version
                additionalProperties = balanceUpdateBody.additionalProperties.toMutableMap()
            }
    ...
    class Builder internal constructor() {
        ...
        private var body: BalanceUpdateBody.Builder = BalanceUpdateBody.builder()
