...
private constructor(
    ...
    class Builder internal constructor() {
        ...
        internal fun from(
            ...
            body = permissionPolicyRemoveFromServiceUserParams.body.toBuilder()
            additionalHeaders =
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return /* spotless:off */ other is PermissionPolicyRemoveFromServiceUserParams && orgId == other.orgId && permissionPolicyId == other.permissionPolicyId && body == other.body && additionalHeaders == other.additionalHeaders && additionalQueryParams == other.additionalQueryParams /* spotless:on */
    }
    ...
    override fun toString() =
        "PermissionPolicyRemoveFromServiceUserParams{orgId=$orgId, permissionPolicyId=$permissionPolicyId, body=$body, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
