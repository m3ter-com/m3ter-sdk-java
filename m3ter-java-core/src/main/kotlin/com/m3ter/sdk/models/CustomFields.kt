...
private constructor(
    ...
    class Builder internal constructor() {
        ...
        internal fun from(customFields: CustomFields) = apply {
            ...
            account = customFields.account
            accountPlan = customFields.accountPlan
            aggregation = customFields.aggregation
            compoundAggregation = customFields.compoundAggregation
            createdBy = customFields.createdBy
            dtCreated = customFields.dtCreated
            dtLastModified = customFields.dtLastModified
            lastModifiedBy = customFields.lastModifiedBy
            meter = customFields.meter
            organization = customFields.organization
            plan = customFields.plan
            planTemplate = customFields.planTemplate
    ...
    override fun toString() =
        "CustomFields{id=$id, version=$version, account=$account, accountPlan=$accountPlan, aggregation=$aggregation, compoundAggregation=$compoundAggregation, createdBy=$createdBy, dtCreated=$dtCreated, dtLastModified=$dtLastModified, lastModifiedBy=$lastModifiedBy, meter=$meter, organization=$organization, plan=$plan, planTemplate=$planTemplate, product=$product, additionalProperties=$additionalProperties}"
}
