...
private constructor(
    ...
    fun data(): List<Product> = response().data()
    ...
    @JsonCreator
    constructor(
        @JsonProperty("data") private val data: JsonField<List<Product>> = JsonMissing.of(),
        @JsonProperty("nextToken") private val nextToken: JsonField<String> = JsonMissing.of(),
        @JsonAnySetter
        private val additionalProperties: Map<String, JsonValue> = immutableEmptyMap(),
    ) {

        fun data(): List<Product> = data.getNullable("data") ?: listOf()

        fun nextToken(): Optional<String> = Optional.ofNullable(nextToken.getNullable("nextToken"))

        @JsonProperty("data")
        fun _data(): Optional<JsonField<List<Product>>> = Optional.ofNullable(data)
    ...
    class AutoPager(
        private val firstPage: ProductListPageAsync,
    ) {

        fun forEach(action: Predicate<Product>, executor: Executor): CompletableFuture<Void> {
            fun CompletableFuture<Optional<ProductListPageAsync>>.forEach(
                action: (Product) -> Boolean,
                executor: Executor
        ...
        fun toList(executor: Executor): CompletableFuture<List<Product>> {
            val values = mutableListOf<Product>()
