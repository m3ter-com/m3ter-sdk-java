...
private constructor(
    ...
    fun data(): List<ProductResponse> = response().data()
    ...
    class Response(
        ...
        @JsonCreator
        private constructor(
            @JsonProperty("data") data: JsonField<List<ProductResponse>> = JsonMissing.of(),
            @JsonProperty("nextToken") nextToken: JsonField<String> = JsonMissing.of(),
        ) : this(data, nextToken, mutableMapOf())

        fun data(): List<ProductResponse> = data.getOptional("data").getOrNull() ?: listOf()

        fun nextToken(): Optional<String> = nextToken.getOptional("nextToken")

        @JsonProperty("data")
        fun _data(): Optional<JsonField<List<ProductResponse>>> = Optional.ofNullable(data)
        ...
        class Builder {
            ...
            private var data: JsonField<List<ProductResponse>> = JsonMissing.of()
            ...
            fun data(data: JsonField<List<ProductResponse>>) = apply { this.data = data }
