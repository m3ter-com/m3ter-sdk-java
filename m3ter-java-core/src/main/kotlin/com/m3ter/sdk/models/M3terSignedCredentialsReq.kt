...
@NoAutoDetect
class M3terSignedCredentialsReq
@JsonCreator
private constructor(
    @JsonProperty("apiKey")
    @ExcludeMissing
    ...
    fun validate(): M3terSignedCredentialsReq = apply {
        if (validated) {
            return@apply
        }
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [M3terSignedCredentialsReq].
         *
    ...
    /** A builder for [M3terSignedCredentialsReq]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(m3terSignedCredentialsReq: M3terSignedCredentialsReq) = apply {
            apiKey = m3terSignedCredentialsReq.apiKey
            secret = m3terSignedCredentialsReq.secret
            type = m3terSignedCredentialsReq.type
            empty = m3terSignedCredentialsReq.empty
            version = m3terSignedCredentialsReq.version
            additionalProperties = m3terSignedCredentialsReq.additionalProperties.toMutableMap()
        }
        ...
        fun build(): M3terSignedCredentialsReq =
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return /* spotless:off */ other is M3terSignedCredentialsReq && apiKey == other.apiKey && secret == other.secret && type == other.type && empty == other.empty && version == other.version && additionalProperties == other.additionalProperties /* spotless:on */
    }
    ...
    override fun toString() =
        "M3terSignedCredentialsReq{apiKey=$apiKey, secret=$secret, type=$type, empty=$empty, version=$version, additionalProperties=$additionalProperties}"
}
