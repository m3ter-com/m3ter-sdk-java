...
private constructor(
    ...
    class AutoPager(private val firstPage: ExternalMappingListByExternalEntityPageAsync) {
        ...
        fun toList(executor: Executor): CompletableFuture<List<ExternalMapping>> {
            val values = mutableListOf<ExternalMapping>()
