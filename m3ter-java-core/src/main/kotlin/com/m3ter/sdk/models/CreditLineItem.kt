...
private constructor(
    ...
    fun validate(): CreditLineItem = apply {
        if (validated) {
            return@apply
        }
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [CreditLineItem].
         *
    ...
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(creditLineItem: CreditLineItem) = apply {
            id = creditLineItem.id
            amount = creditLineItem.amount
            description = creditLineItem.description
            productId = creditLineItem.productId
            referencedBillId = creditLineItem.referencedBillId
            referencedLineItemId = creditLineItem.referencedLineItemId
            servicePeriodEndDate = creditLineItem.servicePeriodEndDate
            servicePeriodStartDate = creditLineItem.servicePeriodStartDate
            version = creditLineItem.version
            createdBy = creditLineItem.createdBy
            creditReasonId = creditLineItem.creditReasonId
            dtCreated = creditLineItem.dtCreated
            dtLastModified = creditLineItem.dtLastModified
            lastModifiedBy = creditLineItem.lastModifiedBy
            additionalProperties = creditLineItem.additionalProperties.toMutableMap()
        }
