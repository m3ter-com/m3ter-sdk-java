...
private constructor(
    ...
    class Builder internal constructor() {
        ...
        internal fun from(accountRetrieveParams: AccountRetrieveParams) = apply {
            orgId = accountRetrieveParams.orgId
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return /* spotless:off */ other is AccountRetrieveParams && orgId == other.orgId && id == other.id && additionalHeaders == other.additionalHeaders && additionalQueryParams == other.additionalQueryParams /* spotless:on */
    }

    override fun hashCode(): Int = /* spotless:off */ Objects.hash(orgId, id, additionalHeaders, additionalQueryParams) /* spotless:on */

    override fun toString() =
        "AccountRetrieveParams{orgId=$orgId, id=$id, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
