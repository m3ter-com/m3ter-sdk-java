...
private constructor(
    ...
    class AutoPager(private val firstPage: ResourceGroupListPermissionsPageAsync) {
        ...
        fun toList(executor: Executor): CompletableFuture<List<PermissionPolicy>> {
            val values = mutableListOf<PermissionPolicy>()
