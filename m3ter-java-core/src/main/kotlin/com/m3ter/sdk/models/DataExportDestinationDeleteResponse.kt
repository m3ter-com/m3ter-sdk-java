...
private constructor(
    ...
    /** A builder for [DataExportDestinationDeleteResponse]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(
            dataExportDestinationDeleteResponse: DataExportDestinationDeleteResponse
        ) = apply {
            id = dataExportDestinationDeleteResponse.id
            version = dataExportDestinationDeleteResponse.version
            code = dataExportDestinationDeleteResponse.code
            createdBy = dataExportDestinationDeleteResponse.createdBy
            dtCreated = dataExportDestinationDeleteResponse.dtCreated
            dtLastModified = dataExportDestinationDeleteResponse.dtLastModified
            lastModifiedBy = dataExportDestinationDeleteResponse.lastModifiedBy
            name = dataExportDestinationDeleteResponse.name
            bucketName = dataExportDestinationDeleteResponse.bucketName
            iamRoleArn = dataExportDestinationDeleteResponse.iamRoleArn
            partitionOrder = dataExportDestinationDeleteResponse.partitionOrder
            prefix = dataExportDestinationDeleteResponse.prefix
            additionalProperties =
                dataExportDestinationDeleteResponse.additionalProperties.toMutableMap()
        }
        ...
        /**
         * Returns an immutable instance of [DataExportDestinationDeleteResponse].
         *
         ...
         */
        fun build(): DataExportDestinationDeleteResponse =
            DataExportDestinationDeleteResponse(
                checkRequired("id", id),
