...
@NoAutoDetect
class PermissionPolicyAddToServiceUserResponse
@JsonCreator
private constructor(
    ...
    /** A builder for [PermissionPolicyAddToServiceUserResponse]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(
            permissionPolicyAddToServiceUserResponse: PermissionPolicyAddToServiceUserResponse
        ) = apply {
            id = permissionPolicyAddToServiceUserResponse.id
            createdBy = permissionPolicyAddToServiceUserResponse.createdBy
            dtCreated = permissionPolicyAddToServiceUserResponse.dtCreated
            dtLastModified = permissionPolicyAddToServiceUserResponse.dtLastModified
            lastModifiedBy = permissionPolicyAddToServiceUserResponse.lastModifiedBy
            permissionPolicyId = permissionPolicyAddToServiceUserResponse.permissionPolicyId
            principalId = permissionPolicyAddToServiceUserResponse.principalId
            principalType = permissionPolicyAddToServiceUserResponse.principalType
            version = permissionPolicyAddToServiceUserResponse.version
            additionalProperties =
                permissionPolicyAddToServiceUserResponse.additionalProperties.toMutableMap()
        }
        ...
        /**
         * Returns an immutable instance of [PermissionPolicyAddToServiceUserResponse].
         *
         * Further updates to this [Builder] will not mutate the returned instance.
         */
        fun build(): PermissionPolicyAddToServiceUserResponse =
            PermissionPolicyAddToServiceUserResponse(
                id,
                createdBy,
                dtCreated,
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return /* spotless:off */ other is PermissionPolicyAddToServiceUserResponse && id == other.id && createdBy == other.createdBy && dtCreated == other.dtCreated && dtLastModified == other.dtLastModified && lastModifiedBy == other.lastModifiedBy && permissionPolicyId == other.permissionPolicyId && principalId == other.principalId && principalType == other.principalType && version == other.version && additionalProperties == other.additionalProperties /* spotless:on */
    }
    ...
    override fun toString() =
        "PermissionPolicyAddToServiceUserResponse{id=$id, createdBy=$createdBy, dtCreated=$dtCreated, dtLastModified=$dtLastModified, lastModifiedBy=$lastModifiedBy, permissionPolicyId=$permissionPolicyId, principalId=$principalId, principalType=$principalType, version=$version, additionalProperties=$additionalProperties}"
}
