...
private constructor(
    ...
    class Builder internal constructor() {
        ...
        internal fun from(
            ...
            body = permissionPolicyAddToUserGroupParams.body.toBuilder()
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return /* spotless:off */ other is PermissionPolicyAddToUserGroupParams && orgId == other.orgId && permissionPolicyId == other.permissionPolicyId && body == other.body && additionalHeaders == other.additionalHeaders && additionalQueryParams == other.additionalQueryParams /* spotless:on */
    }
    ...
    override fun toString() =
        "PermissionPolicyAddToUserGroupParams{orgId=$orgId, permissionPolicyId=$permissionPolicyId, body=$body, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
