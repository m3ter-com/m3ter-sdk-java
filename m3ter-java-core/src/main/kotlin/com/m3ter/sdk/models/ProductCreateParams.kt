 ...
 *
 * This endpoint creates a new Product within the specified Organization. The details of the Product
...
constructor(
    ...
    @JvmSynthetic internal fun getBody(): ProductCreateBody = body
    ...
    class Builder {
        ...
        internal fun from(productCreateParams: ProductCreateParams) = apply {
            orgId = productCreateParams.orgId
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return /* spotless:off */ other is ProductCreateParams && orgId == other.orgId && body == other.body && additionalHeaders == other.additionalHeaders && additionalQueryParams == other.additionalQueryParams /* spotless:on */
    }

    override fun hashCode(): Int = /* spotless:off */ Objects.hash(orgId, body, additionalHeaders, additionalQueryParams) /* spotless:on */

    override fun toString() =
        "ProductCreateParams{orgId=$orgId, body=$body, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
