...
class PermissionPolicyAddToUserResponse
private constructor(
    ...
    /** A builder for [PermissionPolicyAddToUserResponse]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(permissionPolicyAddToUserResponse: PermissionPolicyAddToUserResponse) =
            apply {
                id = permissionPolicyAddToUserResponse.id
                createdBy = permissionPolicyAddToUserResponse.createdBy
                dtCreated = permissionPolicyAddToUserResponse.dtCreated
                dtLastModified = permissionPolicyAddToUserResponse.dtLastModified
                lastModifiedBy = permissionPolicyAddToUserResponse.lastModifiedBy
                permissionPolicyId = permissionPolicyAddToUserResponse.permissionPolicyId
                principalId = permissionPolicyAddToUserResponse.principalId
                principalType = permissionPolicyAddToUserResponse.principalType
                version = permissionPolicyAddToUserResponse.version
                additionalProperties =
                    permissionPolicyAddToUserResponse.additionalProperties.toMutableMap()
            }
        ...
        /**
         * Returns an immutable instance of [PermissionPolicyAddToUserResponse].
         *
         * Further updates to this [Builder] will not mutate the returned instance.
         */
        fun build(): PermissionPolicyAddToUserResponse =
            PermissionPolicyAddToUserResponse(
                id,
                createdBy,
                dtCreated,
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return /* spotless:off */ other is PermissionPolicyAddToUserResponse && id == other.id && createdBy == other.createdBy && dtCreated == other.dtCreated && dtLastModified == other.dtLastModified && lastModifiedBy == other.lastModifiedBy && permissionPolicyId == other.permissionPolicyId && principalId == other.principalId && principalType == other.principalType && version == other.version && additionalProperties == other.additionalProperties /* spotless:on */
    }
    ...
    override fun toString() =
        "PermissionPolicyAddToUserResponse{id=$id, createdBy=$createdBy, dtCreated=$dtCreated, dtLastModified=$dtLastModified, lastModifiedBy=$lastModifiedBy, permissionPolicyId=$permissionPolicyId, principalId=$principalId, principalType=$principalType, version=$version, additionalProperties=$additionalProperties}"
}
