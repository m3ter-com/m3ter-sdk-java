...
private constructor(
    ...
    class Builder internal constructor() {
        ...
        internal fun from(
            ...
            body = permissionPolicyRemoveFromUserGroupParams.body.toBuilder()
            additionalHeaders =
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return /* spotless:off */ other is PermissionPolicyRemoveFromUserGroupParams && orgId == other.orgId && permissionPolicyId == other.permissionPolicyId && body == other.body && additionalHeaders == other.additionalHeaders && additionalQueryParams == other.additionalQueryParams /* spotless:on */
    }
    ...
    override fun toString() =
        "PermissionPolicyRemoveFromUserGroupParams{orgId=$orgId, permissionPolicyId=$permissionPolicyId, body=$body, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
