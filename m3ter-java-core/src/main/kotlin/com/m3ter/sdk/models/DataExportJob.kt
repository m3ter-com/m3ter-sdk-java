...
private constructor(
    ...
    fun validate(): DataExportJob = apply {
        if (validated) {
            return@apply
        }
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [DataExportJob].
         *
    ...
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(dataExportJob: DataExportJob) = apply {
            id = dataExportJob.id
            version = dataExportJob.version
            dateCreated = dataExportJob.dateCreated
            scheduleId = dataExportJob.scheduleId
            sourceType = dataExportJob.sourceType
            startedAt = dataExportJob.startedAt
            status = dataExportJob.status
            additionalProperties = dataExportJob.additionalProperties.toMutableMap()
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return /* spotless:off */ other is DataExportJob && id == other.id && version == other.version && dateCreated == other.dateCreated && scheduleId == other.scheduleId && sourceType == other.sourceType && startedAt == other.startedAt && status == other.status && additionalProperties == other.additionalProperties /* spotless:on */
    }
    ...
    override fun toString() =
        "DataExportJob{id=$id, version=$version, dateCreated=$dateCreated, scheduleId=$scheduleId, sourceType=$sourceType, startedAt=$startedAt, status=$status, additionalProperties=$additionalProperties}"
}
