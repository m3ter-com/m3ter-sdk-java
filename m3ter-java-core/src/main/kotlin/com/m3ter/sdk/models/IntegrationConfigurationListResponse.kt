...
private constructor(
    ...
    /** A builder for [IntegrationConfigurationListResponse]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(
            integrationConfigurationListResponse: IntegrationConfigurationListResponse
        ) = apply {
            ...
            destinationId = integrationConfigurationListResponse.destinationId
            dtCreated = integrationConfigurationListResponse.dtCreated
            dtLastModified = integrationConfigurationListResponse.dtLastModified
            enabled = integrationConfigurationListResponse.enabled
            entityId = integrationConfigurationListResponse.entityId
            integrationCredentialsId = integrationConfigurationListResponse.integrationCredentialsId
        ...
        /**
         * Returns an immutable instance of [IntegrationConfigurationListResponse].
         *
         ...
         */
        fun build(): IntegrationConfigurationListResponse =
            IntegrationConfigurationListResponse(
                checkRequired("id", id),
