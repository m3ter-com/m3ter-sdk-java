    ...
    internal constructor(
        ...
        class Builder internal constructor() {
            ...
            internal fun from(accountCreateBody: AccountCreateBody) = apply {
                code = accountCreateBody.code
                emailAddress = accountCreateBody.emailAddress
                name = accountCreateBody.name
                address = accountCreateBody.address
                autoGenerateStatementMode = accountCreateBody.autoGenerateStatementMode
                billEpoch = accountCreateBody.billEpoch
                configData = accountCreateBody.configData
                creditApplicationOrder =
                    accountCreateBody.creditApplicationOrder.map { it.toMutableList() }
                currency = accountCreateBody.currency
                customFields = accountCreateBody.customFields
                daysBeforeBillDue = accountCreateBody.daysBeforeBillDue
                parentAccountId = accountCreateBody.parentAccountId
                purchaseOrderNumber = accountCreateBody.purchaseOrderNumber
                statementDefinitionId = accountCreateBody.statementDefinitionId
                version = accountCreateBody.version
