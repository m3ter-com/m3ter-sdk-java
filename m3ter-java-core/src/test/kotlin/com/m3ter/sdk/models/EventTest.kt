...
class EventTest {
    ...
    fun createEvent() {
        ...
        assertThat(event.id()).isEqualTo("9cb46d85-7cb6-4637-80a1-d4ec38e4ab30")
        assertThat(event.dtActioned()).isEqualTo(OffsetDateTime.parse("2022-10-28T13:56:49.557Z"))
        assertThat(event.eventName()).isEqualTo("configuration.commitment.created")
        assertThat(event.eventTime()).isEqualTo(OffsetDateTime.parse("2022-10-28T13:54:49.557Z"))
        assertThat(event._m3terEvent())
            .isEqualTo(
                JsonValue.from(
                    mapOf(
                        "eventData" to
