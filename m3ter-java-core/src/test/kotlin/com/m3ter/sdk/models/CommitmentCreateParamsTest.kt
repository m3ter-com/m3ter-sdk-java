...
class CommitmentCreateParamsTest {
    ...
    fun body() {
        ...
        assertThat(body.accountingProductId()).contains("accountingProductId")
        ...
        assertThat(body.lineItemTypes())
            .contains(listOf(CommitmentCreateParams.LineItemType.STANDING_CHARGE))
