...
class AuthenticationGetBearerTokenResponseTest {

    @Test
    fun createAuthenticationGetBearerTokenResponse() {
        val authenticationGetBearerTokenResponse =
            AuthenticationGetBearerTokenResponse.builder()
                ...
                .tokenType("Bearer")
                .build()
        assertThat(authenticationGetBearerTokenResponse).isNotNull
        ...
        assertThat(authenticationGetBearerTokenResponse.scope()).isEqualTo("scope")
